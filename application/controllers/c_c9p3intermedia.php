...
class  C_c9p3intermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p3intermedia');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p3intermedia($page = 'v_c9p3intermedia') {
        ...
        $cayudas = $this->m_c9p3intermedia->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p3intermedia->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p3intermedia->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p3intermedia->fm_actualizarpregunta($cfolio,$cidintegrante,$cvalorc9p3intermedia,$cvalorc9p3intermediacual);

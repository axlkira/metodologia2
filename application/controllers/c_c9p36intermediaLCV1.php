...
class  C_c9p36intermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p36intermediaLCV1');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p36intermediaLCV1($page = 'v_c9p36intermediaLCV1') {
...
//        $doccogestor = $this->input->get('doccogestor');
        ...
        $cayudas = $this->m_c9p36intermediaLCV1->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p36intermediaLCV1->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p36intermediaLCV1->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p36intermediaLCV1->fm_actualizarpregunta($cfolio,$cidintegrante,$cc9p36intermediao1,$cc9p36intermediao2,$cc9p36intermediao3,$cc9p36intermediao4,$cc9p36intermediao5,$cc9p36intermediao6,$cc9p36intermediao7,$cc9p36intermediao8,$cc9p36intermediao9);

...
class  C_principalhogar extends CI_Controller {
    ...
    public function fc_principalhogar($page = 'v_principalhogar') {
        ...
        // se  pinta en linea 1 estacion 1
           ...
           // se  pinta en linea 1 estacion 2
            ...
            // se  pinta en linea 2 estacion 1
            ...
            // se  pinta en linea 2 estacion 2
            ...
            // se  pinta en linea 2 estacion 3
            ...
            // se  pinta en linea 2 estacion 4
            if($valor->idestacion == '23' && $valor->casilla !== '9' && $valor->intermedia !== '1' && $valor->casilladf !== '9'){
                 $cont3= 0;
                ++$cont3;
                ++$a6e1;
                $b6e1 = $a6e1 % 2;
            ...
            // se  pinta en linea 2 estacion 5
            ...
            // se  pinta en linea 2 estacion 6
            if($valor->idestacion == '25' && $valor->casilla !== '9'&& $valor->intermedia !== '1' && $valor->casilladf !== '9'){
                 $cont3= 0;
                ++$cont3;
                ++$a9e1;
                $b9e1 = $a9e1 % 2;
            ...
            // se  pinta en linea 2 estacion 7
            if($valor->idestacion == '26' && $valor->casilla !== '9'&& $valor->intermedia !== '1' && $valor->casilladf !== '9'){
                 $cont3= 0;
                ++$cont3;
                ++$a11e1;
                $b11e1 = $a11e1 % 2;

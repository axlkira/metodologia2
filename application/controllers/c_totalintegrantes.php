...
class  C_totalintegrantes extends CI_Controller {
    ...
    public function fc_totalintegrantes($page = 'v_totalintegrantes') {
        ...
        $datosintegrante = $this->m_totalintegrantes->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $idinteexiste = $this->m_totalintegrantes->fm_foloexiste($idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $listartabla = $this->m_totalintegrantes->fm_listartabla($folio);
      ...
      //INICIO TRAER DATOS DE TODAS LAS VALIDACIONES EN EL INGRESO DE INTEGRANTES
        ...
        $datosintegrantemenores = $this->m_totalintegrantes->fm_datosmenores($folio);//lo mandasmos a la funcion del modelo para verificar
        ...
        $tdatintemenores = array('tclasificacionHogar' => $filaintem->clasificacionHogar,
                          ...
                          'ttotalmayores' => $filaintem->totalmayores,
                          'ttotalmenores14' => $filaintem->totalmenores14); //se guarda el resultado del ption value en la variable datos
        }
       
        
     
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_totalintegrantes'; // para el titulo de la vista en la pestaña
        $this->load->view('pages/' . $page,  array('titulo' => $titulo, 'foot' => FOOTS, 'head3' => HEAD3, 'botonerag' => BOTONERAG, 'botoneraa' => BOTONERAA, 'datos'=> $datos,'disabled' => $disabled,  'folio' => $folio, 'foexiste' =>$foexiste, 'tdatinte' => $tdatinte, 'tdatintemenores' => $tdatintemenores)); 
    ...
    public function fc_insertar()
    {
        ...
        $this->m_totalintegrantes->fm_insertar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
    ...
    public function fc_actualizar()
    {
        ...
        $cinstagram = $this->input->get('vinstagram');
        $cgoogle = $this->input->get('vgoogle');
        $this->m_totalintegrantes->fm_actualizar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
        //echo json_encode(array('result' => 'guardado'));

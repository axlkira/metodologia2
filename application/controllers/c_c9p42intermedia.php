...
class  C_c9p42intermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p42intermedia');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p42intermedia($page = 'v_c9p42intermedia') {
        ...
        $cayudas = $this->m_c9p42intermedia->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p42intermedia->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p42intermedia->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p42intermedia->fm_actualizarpregunta($cfolio,$cidintegrante,$cvc9p42intermediao1,$cvc9p42intermediao2,$cvc9p42intermediao3,$cvc9p42intermediao4,$cvc9p42intermediao5,$cvc9p42intermediacual);

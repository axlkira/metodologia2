...
class  C_capitulosintegrante extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_capitulosintegrante');//carga el controlador modelo
    ...
    public function fc_capitulosintegrante($page = 'v_capitulosintegrante') {
        ...
        //FIN TRAER DATOS DEL TITULAR      
         ...
         $crespuestas = $this->m_capitulosintegrante->fm_buscarestadoint($idintegrante);
...
//        inicio cap12
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_capitulosintegrante'; // para el titulo de la vista en la pestaña
        $this->load->view('pages/' . $page,  array('titulo' => $titulo,'foot' => FOOTS, 'head1' => HEAD1, 'botonerag' => BOTONERAG,
                                                   ...
                                                   'datos4' => $datos4,'datos5' => $datos5, 'datos6' => $datos6,'datos7' => $datos7, 
                                                   'folio' => $folio,'datos8' => $datos8, 'datos10' => $datos10,'datos11' => $datos11,
                                                   'datos12' => $datos12,'datos13' => $datos13,'datos14' => $datos14, 'datos15' => $datos15,'folio' => $folio, 'tdatinte' => $tdatinte,
                                                   'cap4' => $cap4,'cap5' => $cap5,'cap7' => $cap7,'cap8' => $cap8,'cap9k'=>$cap9k, 'cap9l'=>$cap9l,'cap9m'=>$cap9m,'cap9n'=>$cap9n,
                                                   'cap9p'=>$cap9p,'cap9q'=>$cap9q,'cap9r'=>$cap9r,'cap10' => $cap10,'cap11' => $cap11,'cap12' => $cap12, 'cap41'=>$cap41, 'cap51'=>$cap51
                                                  ,'cap71'=>$cap71, 'cap81'=>$cap81,'cap9k1'=>$cap9k1,'cap9l1'=>$cap9l1, 'cap9m1'=>$cap9m1, 'cap9n1'=>$cap9n1
                                                  ,'cap9p1'=>$cap9p1,'cap9q1'=>$cap9q1,'cap9r1'=>$cap9r1,'cap101'=> $cap101, 'cap111'=>$cap111, 'cap121'=>$cap121, 'totalcap' => $totalcap ));

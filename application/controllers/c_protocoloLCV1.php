...
class  C_protocoloLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_protocoloLCV1');//carga el controlador modelo
    ...
    public function fc_protocoloLCV1($page = 'v_protocoloLCV1') {
        ...
        $datosintegrante = $this->m_protocoloLCV1->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
      ...
      $idvisita = '90';
      $datosidvisita = $this->m_protocoloLCV1->fm_traerp0informaciongeneral($folio,$idvisita);//lo mandasmos a la funcion del modelo para verificar
      ...
      ///////////////////// FIN NUEVO /////////////////
       ...
       // TRAE EL ULTIMO PASO REALIZADO DE LA ESTACIÓN DIFERENTE A 81
          $maximoidpaso = $this->m_protocoloLCV1->mostrarmaximoidpaso($folio);
        ...
        // TRAE EL ULTIMO PASO REALIZADO DE LA ESTACIÓN IGUAL A 81
          $maximoidpaso81 = $this->m_protocoloLCV1->mostrarmaximoidpaso81($folio);
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_protocoloLCV1'; // para el titulo de la vista en la pestaña
    ...
    public function fc_cerrarpaso()
    {
       ...
       $this->m_protocoloLCV1->fm_cerrarpaso($cfolio,$cidpaso,$cestado);
    }
    ...
    public function fc_cerrarestacion()
    {
       ...
       $this->m_protocoloLCV1->fm_cerrarestacion($cfolio,$cidestacion,$cestado,$this->session->userdata('id'),$this->session->userdata('documento'),$clongitud,$clatitud,$cmensajedonde);
    }
    ...
    public function fc_insertarfolioexitoso()
    {
       $cidestacion = $this->input->get('videstacion');       
       $cfolio = $this->input->get('vfolio');       
       $this->m_protocoloLCV1->fm_insertarfolioexitoso($cfolio,$cidestacion);
    }
    ...
    public function fc_insertarfoliohogarintermedia()
    {
       ...
       $cfolio = $this->input->get('vfolio');       
       $this->m_protocoloLCV1->fm_insertarfoliohogarintermedia($cfolio);
    }
    ...
    {
       $cfolio = $this->input->get('vfolio');       
       $this->m_protocoloLCV1->fm_saltohogarintermedia($cfolio);
    }
    public function fc_calcularprivacionesinter()
    {
       $cfolio = $this->input->get('vfolio');       
       $this->m_protocoloLCV1->fm_calcularprivacionesinter($cfolio);
    }
...
public function fc_actualizarep0()
{
   ...
   $fechaIni = $this->m_protocoloLCV1->fm_actualizarep0($cfolio,$cidestacion,$cvalorp0,$cvcualmotivo,$cdoccogestor);

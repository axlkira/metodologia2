...
class  C_c9p35intermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p35intermediaLCV1');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p35intermediaLCV1($page = 'v_c9p35intermediaLCV1') {
        ...
        $cayudas = $this->m_c9p35intermediaLCV1->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p35intermediaLCV1->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p35intermediaLCV1->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p35intermediaLCV1->fm_actualizarpregunta($cfolio,$cidintegrante,$cc9p35intermediao1,$cc9p35intermediao2,$cc9p35intermediao3,$cc9p35intermediao4,$cc9p35intermediao5,$cc9p35intermediao6,$cc9p35intermediao7,$cc9p35intermediao7cual,$cc9p35intermediao8,$cc9p35intermediao9);

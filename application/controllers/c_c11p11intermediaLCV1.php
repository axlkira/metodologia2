...
class  C_c11p11intermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c11p11intermediaLCV1');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c11p11intermediaLCV1($page = 'v_c11p11intermediaLCV1') {
        ...
        $cayudas = $this->m_c11p11intermediaLCV1->fm_ayudas();
        ...
        $cdatosgenerales = $this->m_c11p11intermediaLCV1->fm_cargardatosgenerales($cfolio);
        ...
        $crespuestas = $this->m_c11p11intermediaLCV1->fm_buscarpregunta($cfolio);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c11p11intermediaLCV1->fm_actualizarpregunta($cfolio,$cvalorc11p11intermediao1,$cvalorc11p11intermediao2,$cvalorc11p11intermediao3,$cvalorc11p11intermediao4,
    ...
    public function fc_cerrarpaso()
    {
       ...
       $this->m_c11p11intermediaLCV1->fm_cerrarpaso($cfolio,$cidpaso,$cestado);
    }

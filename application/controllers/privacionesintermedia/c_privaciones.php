...
class C_privaciones extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('/privacionesintermedia/m_privaciones');
    }
...
//        fin armar tabla
       ...
       //ESTO LEVANTA LA VISTA     
        ...
        $this->load->view('pages/privacionesintermedia/'.$page,  array('titulo' => $titulo, 'foot' => FOOTS, 'head' => HEAD1, 'botoneral' => BOTONERALOGROS, 'privacion' => $privacionresul, 'folio' => $folio, 'doccogestor' => $doccogestor, 'foexiste' =>$foexiste, 'iddimen' => $iddimension, 'idpriva' => $idprivacion,'tabla' => $tabla,'colordimen' => $colordimension));

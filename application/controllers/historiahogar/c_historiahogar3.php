...
class  C_historiahogar3 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('/historiahogar/m_historiahogar3');//carga el controlador modelo
    ...
    public function fc_historiahogar3($page = 'v_historiahogar3') {
        ...
        $cayudas = $this->m_historiahogar3->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_historiahogar3->fm_cargardatosgenerales($cfolio);
        ...
        //traer los logros
        $cdatoshflogros = $this->m_historiahogar3->fm_traerhflogro($cfolio);
        //traer los datos
        $carraytraerlogros = '';
        ...
        $cdatoshfconformacion = $this->m_historiahogar3->fm_traerhfconformacion($cfolio);
        //traer los datos
        ...
        $cdatoshfprocedencia = $this->m_historiahogar3->fm_traerhfprocedencia($cfolio);
        //traer los datos
        ...
        $cdatoshfcostumbres = $this->m_historiahogar3->fm_traerhfcostumbres($cfolio);
        //traer los datos
        ...
        $crespuestas = $this->m_historiahogar3->fm_buscarpregunta($cfolio);
    ...
    public function fc_hfinsertarlogro()
    {
        ...
        $cdatoshflogros = $this->m_historiahogar3->fm_insertarhflogro($cfolio,$cestacion,$ctextlogro,$this->session->userdata('documento'));
    //traer los datos
        $carraydatoshflogros = '';
        foreach ($cdatoshflogros as $cdhflogros)
        {
    ...
    public function fc_hfinsertarconformacion()
    {
        ...
        $cestacion= $this->input->post('vestacion');
        $cdatoshfconformacion = $this->m_historiahogar3->fm_insertarhconformacion($cfolio,$cestacion,$ctextconformacion,$this->session->userdata('documento'));
    //traer los datos
    ...
    public function fc_hfinsertarprocedencia()
    {
        ...
        $cestacion= $this->input->post('vestacion');
        $cdatoshfprocedencia = $this->m_historiahogar3->fm_insertarhfprocedencia($cfolio,$cestacion,$ctextprocedencia,$this->session->userdata('documento'));
    //traer los datos
    ...
    public function fc_hfinsertarcostumbres()
    {
        ...
        $cestacion= $this->input->post('vestacion');
        $cdatoshfconstumbres = $this->m_historiahogar3->fm_insertarhfconstumbres($cfolio,$cestacion,$ctextconstumbres,$this->session->userdata('documento'));
    //traer los datos
    ...
    public function fc_cerrarpaso()
    {
       ...
       $this->m_historiahogar3->fm_cerrarpaso($cfolio,$cidpaso,$cestado);
    }

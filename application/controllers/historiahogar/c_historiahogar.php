...
class  C_historiahogar extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('/historiahogar/m_historiahogar');//carga el controlador modelo
    ...
    public function fc_historiahogar($page = 'v_historiahogar') {
        ...
        $cayudas = $this->m_historiahogar->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_historiahogar->fm_cargardatosgenerales($cfolio);
        ...
        //traer los logros
        $cdatoshflogros = $this->m_historiahogar->fm_traerhflogro($cfolio);
        //traer los datos
        $carraytraerlogros = '';
        $logroscont = 0;
        ...
        $cdatoshfconformacion = $this->m_historiahogar->fm_traerhfconformacion($cfolio);
        //traer los datos
        ...
        $cdatoshfprocedencia = $this->m_historiahogar->fm_traerhfprocedencia($cfolio);
        //traer los datos
        ...
        $cdatoshfcostumbres = $this->m_historiahogar->fm_traerhfcostumbres($cfolio);
        //traer los datos
        ...
        $crespuestas = $this->m_historiahogar->fm_buscarpregunta($cfolio);
       ...
       //Levantar vista     
        ...
        $this->load->view('pages/historiahogar/' . $page,  array('titulo' => $titulo, 
                                                   ...
                                                   'historiacont' => $historiacont,
                                                   'procedecont' => $procedecont,
                                                   'costumbrescont' => $costumbrescont,
                                                   'logroscont' => $logroscont,
    ...
    public function fc_hfinsertarlogro()
    {
        ...
        $cdatoshflogros = $this->m_historiahogar->fm_insertarhflogro($cfolio,$cestacion,$ctextlogro,$this->session->userdata('documento'));
    //traer los datos
        $carraydatoshflogros = '';
        $logroscont = 0;
        foreach ($cdatoshflogros as $cdhflogros)
    ...
    //fin traer los datos
      ...
      echo json_encode(array('carraydatoshflogros'=>$carraydatoshflogros,'logroscont'=>$logroscont));
    }
    ...
    public function fc_hfinsertarconformacion()
    {
        ...
        $cestacion= $this->input->post('vestacion');
        $cdatoshfconformacion = $this->m_historiahogar->fm_insertarhconformacion($cfolio,$cestacion,$ctextconformacion,$this->session->userdata('documento'));
    //traer los datos
        ...
        $historiacont = 1;
        //fin traer los datos
        echo json_encode(array('carraydatoshfconformacion'=>$carraydatoshfconformacion,'historiacont'=>$historiacont));
    }
    ...
    public function fc_hfinsertarprocedencia()
    {
        ...
        $cestacion= $this->input->post('vestacion');
        $cdatoshfprocedencia = $this->m_historiahogar->fm_insertarhfprocedencia($cfolio,$cestacion,$ctextprocedencia,$this->session->userdata('documento'));
    //traer los datos
      ...
      echo json_encode(array('carraydatoshfprocedencia'=>$carraydatoshfprocedencia,'procedecont'=>$procedecont));
    }
    //fin funcion para actualizar conformacion    
    //funcion para actualizar conformacion
    public function fc_hfinsertarcostumbres()
    {
        ...
        $cestacion= $this->input->post('vestacion');
        $cdatoshfconstumbres = $this->m_historiahogar->fm_insertarhfconstumbres($cfolio,$cestacion,$ctextconstumbres,$this->session->userdata('documento'));
    //traer los datos
    ...
    echo json_encode(array('carraydatoshfconstumbres'=>$carraydatoshfconstumbres,'costumbrescont'=>$costumbrescont));
    }
    //fin funcion para actualizar conformacion       

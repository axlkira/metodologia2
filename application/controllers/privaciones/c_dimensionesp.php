...
class C_dimensionesp extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('/privaciones/m_dimensionesp');
    }
        ...
        switch ($privacion->iddimension) 
                {   
                    case '2'://actual
                     ...
                     <a onclick="iravista('.$folio.','.$privacion->iddimension.','.$privacion->idprivacion.')">'.$privacion->privacion.'</a>
                     </h4>
                     </div>

...
class  C_c9p27intermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p27intermediaLCV1');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p27intermediaLCV1($page = 'v_c9p27intermediaLCV1') {
        ...
        $cayudas = $this->m_c9p27intermediaLCV1->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p27intermediaLCV1->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p27intermediaLCV1->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p27intermediaLCV1->fm_actualizarpregunta($cfolio,$cidintegrante,$cc9p27intermediao1,$cc9p27intermediao1cuanto,$cc9p27intermediao2,$cc9p27intermediao2cuanto,$cc9p27intermediao3,$cc9p27intermediao3cuanto);

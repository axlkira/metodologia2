...
class C_capituloshogarintermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_capituloshogarintermediaLCV1'); //carga el controlador modelo
    ...
    public function fc_capituloshogarintermediaLCV1($page = 'v_capituloshogarintermediaLCV1') {
        ...
        $datosintegrante = $this->m_capituloshogarintermediaLCV1->fm_datosintegrante($folio, $idintegrante); //lo mandasmos a la funcion del modelo para verificar
...
//traer una lista de valores cap 2
        $listartabla = $this->m_capituloshogarintermediaLCV1->fm_listartablacap2($folio);
...
//traer una lista de valores cap 6
        $listartabla = $this->m_capituloshogarintermediaLCV1->fm_listartablacap6($folio);
        $c6 = '';
        $datos6 = '';
        $cap6 = '';
        foreach ($listartabla as $valor) {
...
//traer una lista de valores cap 11
        $listartabla = $this->m_capituloshogarintermediaLCV1->fm_listartablacap11($folio);
        $c11 = '';
        $datos11 = '';
        $cap11 = '';
        foreach ($listartabla as $valor) {
...
//fin traer una lista de valores cap 11
    ...
    public function fc_cerrarform() {
        ...
        $this->m_capituloshogarintermediaLCV1->fm_cerrarform($cfolio, $cidpaso, $cestado);
    }

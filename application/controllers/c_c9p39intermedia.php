...
class  C_c9p39intermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p39intermedia');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p39intermedia($page = 'v_c9p39intermedia') {
        ...
        $cayudas = $this->m_c9p39intermedia->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p39intermedia->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p39intermedia->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p39intermedia->fm_actualizarpregunta($cfolio,$cidintegrante,$cvc9p39intermediao1,$cvc9p39intermediao2,$cvc9p39intermediao3,$cvc9p39intermediao4,$cvc9p39intermediao5,$cvc9p39intermediao6,

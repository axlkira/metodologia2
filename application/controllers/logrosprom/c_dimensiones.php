...
//            if($this->session->userdata('idestacion') == '21'){
//
//            }else{
...
//            if($this->session->userdata('idestacion') == '21' || $this->session->userdata('idestacion') == '0'){
//
//            }else{
...
//fin traer valores porcentaje de logros que aplican cn
        ...
        //// chacha
        $colordimension1PF = '';$colordimensionverde1PF = '';$colordimensionrojo1PF = '';$colordimensiongris1PF = '';$colordimensioncafe1PF = '';$colordimensionrojo1PF = '';$colordimensiongris1PF = '';$colordimensionazul1PF = '';
        $colordimension2PF = '';$colordimensionverde2PF = '';$colordimensionrojo2PF = '';$colordimensiongris2PF = '';$colordimensioncafe2PF = '';$colordimensionrojo2PF = '';$colordimensiongris2PF = '';$colordimensionazul2PF = '';
        $colordimension3PF = '';$colordimensionverde3PF = '';$colordimensionrojo3PF = '';$colordimensiongris3PF = '';$colordimensioncafe3PF = '';$colordimensionrojo3PF = '';$colordimensiongris3PF = '';$colordimensionazul3PF = '';
        $colordimension4PF = '';$colordimensionverde4PF = '';$colordimensionrojo4PF = '';$colordimensiongris4PF = '';$colordimensioncafe4PF = '';$colordimensionrojo4PF = '';$colordimensiongris4PF = '';$colordimensionazul4PF = '';
...
<div class="panel-heading" role="tab" id="headingOne">
  ...
  <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">IDENTIFICACION</a>
    ...
    <span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 30%;-webkit-border-radius: 50%;border-radius: 50%;background: '.$colordimension1PF.'" >&nbsp;</span>    
    </div>
...
<div class="row" style="vertical-align: ">  
 ...
 <a class="collapsed" role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">INGRESOS Y TRABAJO</a>
    ...
    <span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 30%;-webkit-border-radius: 50%;border-radius: 50%;background: '.$colordimension2PF.'" >&nbsp;</span>
    </div>
   </div>
</div>
...
<div class="panel panel-default">
    ...
    <span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 30%;-webkit-border-radius: 50%;border-radius: 50%;background: '.$colordimension3PF.'" >&nbsp;</span>    
    </div>
    </div>
</div>
...
<div class="panel panel-default">
    ...
    <span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: '.$colordimension4PF.'" >&nbsp;</span>
    </div>
    </div>
</div>

    ...
    public function fc_logros($page = 'v_logros') {
      ...
      //  $idintegrante = $this->input->get('idintegrante');
        ...
        if($logro->colorlogroPF == 0)
        {
                ...
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101"  title="Movimiento del logro por GESTIÓN DE OPORTUNIDADES">&nbsp;</span>';
        }
        else if($logro->colorlogroPF == 1)
                {
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #30E24E"  title="Gestionar Oportunidades">&nbsp;</span>';            
                }
                ...
                {
                $bolitaintPF ='<span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #8B4513" >&nbsp;</span>';            
                }
        else 
                {
        ...
        {
                // $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101" onclick="modalescogeropcionoportdificulcf('.$logro->idlogro.','.$logro->folio.','.$logro->idintegrante.')" title="Movimiento del logro por GESTIÓN DE OPORTUNIDADES o DIFICULTAD PARA ALCANZARLO">&nbsp;</span>';    
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101" title="Solo Consulta">&nbsp;</span>';    
        }
        else if($logro->colorlogroPF == 1)
                {
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #30E24E"  title="Solo Consulta">&nbsp;</span>';            
                }
        else if($logro->colorlogroPF == 2)
                {
                $bolitaintPF ='<span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #D1DFD3" >&nbsp;</span>';            
                ...
                if($logro->colorlogroPF == 0)
        {
                ...
                {
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #30E24E"  title="Solo consult">&nbsp;</span>';            
                }
        else if($logro->colorlogroPF == 2)
                {
                $bolitaintPF ='<span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #D1DFD3" >&nbsp;</span>';            
          ...
          if($logro->colorlogroDI == 0)
        {
               $bolitaint ='<span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101" >&nbsp;</span>';
                ...
                if($logro->colorlogroPF == 0)
        {
                 $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101"  title="El logro solo se mueve por CRUCE INSTITUCIONAL o DIFICULTAD PARA ALCANZARLO, pero puede GESTIONAR OPORTUNIDADES">&nbsp;</span>';   
        }
        else if($logro->colorlogroPF == 1)
                {
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #30E24E"  title="Gestionar Oportunidades -- (el logro solo se mueve por cruce institucional)">&nbsp;</span>';            
                }
        else if($logro->colorlogroPF == 2)
                {
                $bolitaintPF ='<span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #D1DFD3" >&nbsp;</span>';            
        ...
        $texto = '<div class="panel-body">
                     ...
                     <div class="col-md-8">
                     <h3 class="panel-title">
                     logro 7: Las personas entre 18 a 65 años que lo requieren acceden a servicios de intermediación laboral
                     </h3><br>
                     <p>Requieren intermediación laboral las personas en edad de trabajar que están disponibles y no han llevado su hoja de vida a bolsas de empleo o intermediarios.</p>
                     </div>
                     <div class="col-lg-offset-11">
                     Dimension
                     <span class="badge" style="width: 50px;height: 50px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #'.$colordimensionPF.'" >&nbsp;</span>
          ...
          if($logro->colorlogroDI == 0)
        {
         $bolitaint ='<span class="badge" style="width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101">&nbsp;</span>';
                ...
                if($logro->colorlogroPF == 0)
        {
               $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #DF0101"  title="Movimiento del logro por GESTIÓN DE OPORTUNIDADES o VERIFICACIÓN DEL COGESTOR o DIFICULTAD PARA ALCANZARLO">&nbsp;</span>';
        }
        else if($logro->colorlogroPF == 1)
                {
                $bolitaintPF ='<span class="badge" style="cursor:pointer;width: 30px;height: 30px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #30E24E"  title="Gestionar Oportunidades">&nbsp;</span>'; 
        ...
        $texto = '<div class="panel-body">
                     ...
                     <div class="col-md-8">
                     <h3 class="panel-title">
                     logro 9: Los hombres y las mujeres entre 18 y 65 años que lo requieran acceden a apoyo a emprendimientos o fortalecimiento de Unidades Productivas
                     </h3><br>
                     <p>Requieren apoyo a emprendimiento las personas que tengan una idea de nogocio o un negocio funcionando y no han recibido apoyo, fortalecimiento, ni créditos con fondos de emprendimiento.</p>
                     </div>
                     <div class="col-lg-offset-11">
                     Dimension
                     <span class="badge" style="width: 50px;height: 50px;-moz-border-radius: 50%;-webkit-border-radius: 50%;border-radius: 50%;background: #'.$colordimensionPF.'" >&nbsp;</span>
...
if($idlogro == 10){
       ...
       // fin traer una lista de valores logro 18
        ...
        $texto = '<div class="panel-body">
                     ...
                     <div class="col-md-8">
                     <h3 class="panel-title">
                     logro 23: Los hombres del hogar mayores de 40 años  asisten a los programas de tamizaje de próstata
                     </h3><br>
                     <p></p>
                     </div>
                     <div class="col-lg-offset-11">
    ...
    $elogro7='<label id="elogro7" class="control-label">Verificacion del registro de hoja de vida en Bolsas de empleo o de vinculación laboral.</label>';    
    $elogro8='<label id="elogro8" class="control-label">Verificación del certificado adquirido de formación para el trabajo.</label>';   
    $elogro9='<label id="elogro9" class="control-label">Se verifica el acceso a emprendimiento o fortalecimiento de unidad productiva.</label>';       
...
//   $logrosxoportunidad = $this->m_logros->fm_logroxportunidad($idlogro);
//        $tablalogxopor ='';
//     //   $estadooportu = '';
//        foreach ($logrosxoportunidad as $logroxoport)
//        {       
//          //  if($logroxoport->idestado='3')
//          //  {
//          //  $estadooportu = 'No efectiva';
//          //  }
//            
////            $estadoxoportunidadxint = $this->m_logros->fm_logroxportunidad($logroxoport->idoportunidad,);
//       
//            
//            
//            
...
//                .'<td><button type="button" id="edicion'.$logroxoport->idoportunidad.''.$logroxoport->idlogro.'" onclick="exampleModallogroxoportunidadinfo('.$logroxoport->idoportunidad.')" class="btn btn-warning btn-sm">Ver Información</button></td>'        
//               // .'<td><button type="button" id="edicion'.$logroxoport->idoportunidad.''.$logroxoport->idlogro.'" onclick="exampleModallogroxoportunidadinfo('.$logroxoport->idoportunidad.')" class="btn btn-warning btn-sm">'.$estadooportu.'</button></td>'        
//                .'<td><button type="button" id="edicion'.$logroxoport->idoportunidad.''.$logroxoport->idlogro.'" onclick="exampleModallogroxoportunidadsino('.$logroxoport->idoportunidad.','.$logroxoport->idlogro.','.$folio.','.$logroxoport->versionn.')" class="btn btn-success btn-sm">Efectividad</button></td>
//                </tr>';
//        }
//// fin traer las oportunidades por logros  
        //ESTO LEVANTA LA VISTA     
        $titulo = 'v_logros'; // para el titulo de la vista en la pestaña
        $this->load->view('pages/logros/'.$page,  array('titulo' => $titulo, 'foot' => FOOTS, 'head' => HEAD1, 'botoneral' => BOTONERALOGROS, 'logro' => $logroresul, 'folio' => $folio, 'doccogestor' => $doccogestor, 'foexiste' =>$foexiste, 'iddimen' => $iddimension, 'idlog' => $idlogro,'tabla' => $tabla,'colordimen' => $colordimension,'elogro7' => $elogro7,'elogro8' => $elogro8,'elogro9' => $elogro9,'elogro11' => $elogro11,'elogro12' => $elogro12,'elogro13' => $elogro13,'elogro14' => $elogro14,'elogro15' => $elogro15,'elogro17' => $elogro17,'elogro22' => $elogro22,'elogro23' => $elogro23,'elogro28' => $elogro28,'elogro29' => $elogro29,'elogro30' => $elogro30,'elogro31' => $elogro31,'elogro32' => $elogro32,'elogro36' => $elogro36,'elogro37' => $elogro37,'elogro38' => $elogro38,'elogro40' => $elogro40));
    ...
    {   
        ...
        $this->m_logros->fm_insertarlogroxoport($cfolio,$cidintegrantemodaloport,$cidlogro,$cidoportunidad,$cversion,$cdoccogestor,$cvaloropo);
        //echo json_encode(array('result' => 'guardado'));
    }

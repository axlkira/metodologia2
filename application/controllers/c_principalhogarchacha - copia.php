...
class  C_principalhogar extends CI_Controller {
    ...
    public function fc_principalhogar($page = 'v_principalhogar') {
        ...
        {
            $editllbf= '<td><button type="button" id="ellbf" onclick="editallbf('.$valor->folio.','.$valor->idintegrantetitular.')" class="btn btn-success btn-sm" >EDICION LLBF</button></td>';
        }
        else
        {
            $editllbf = '<td><button type="button" id="ellbf" style="display: none"  class="btn btn-success btn-sm">EDICION LLBF</button></td>'; 
        }
          ...
          // if( ($valor->idestacion == '' || $valor->idestacion == '10') && $valor->intermedia == '' ) {
            ...
            // linea 2 estacion 4
                if(($valor->idestacion == '23' && $valor->intermedia !== '1')||
                   ($valor->idestacion == '23' && $valor->casilladf !== '9' && $valor->intermedia == '1' && $valor->idestacion81 == '81')){
            ...
            // linea 2 estacion 7
            if(($valor->idestacion == '26' && $valor->intermedia !== '1')||
               ($valor->idestacion == '26' && $valor->casilladf !== '9' && $valor->intermedia == '1' && $valor->idestacion81 == '81' && $valor->foliointerhistor !== '')){
...
//        }
    ...
    public function fc_traerfolio()
    {
        ...
        if($valor->editar_llbf == '11')
        {
            $editllbf= '<td><button type="button" id="ellbf" class="btn btn-success btn-sm" >EDICION LLBF</button></td>';
        }
        else
        {
            $editllbf = '<td><button type="button" id="ellbf" style="display: none" onclick="vereerf('.$valor->folio.',\''.$valor->nombre1.' '.$valor->nombre2.' '.$valor->apellido1.' '.$valor->apellido2.'\')" class="btn btn-success btn-sm">EDICION LLBF</button></td>'; 
        }
          //linea 1 estacion 1            
          // if( ($valor->idestacion == '' || $valor->idestacion == '10') && $valor->intermedia == '' ) {
            if(($valor->idestacion == '' || $valor->idestacion == '10')) {   

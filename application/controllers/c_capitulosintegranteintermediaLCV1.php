...
class  C_capitulosintegranteintermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_capitulosintegranteintermediaLCV1');//carga el controlador modelo
    ...
    public function fc_capitulosintegranteintermediaLCV1($page = 'v_capitulosintegranteintermediaLCV1') {
        ...
        $crespuestas = $this->m_capitulosintegranteintermediaLCV1->fm_buscarestadoint($idintegrante);
        $carrayrespuestas= array('eestadointe' => ''); 
        foreach ($crespuestas as $crespuesta)
        {
            $carrayrespuestas = array('eestadointe' => $crespuesta->estadointeintermediaLC);
        }
...
//        fin cap 9
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_capitulosintegranteintermediaLCV1'; // para el titulo de la vista en la pestaña

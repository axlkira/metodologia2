...
class  C_totalintegrantesintermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_totalintegrantesintermedia');//carga el controlador modelo
    ...
    public function fc_totalintegrantesintermedia($page = 'v_totalintegrantesintermedia') {
        ...
        $datosintegrante = $this->m_totalintegrantesintermedia->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $idinteexiste = $this->m_totalintegrantesintermedia->fm_foloexiste($idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $listartabla = $this->m_totalintegrantesintermedia->fm_listartabla($folio);
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_totalintegrantesintermedia'; // para el titulo de la vista en la pestaña
    ...
    public function fc_insertar()
    {
        ...
        $this->m_totalintegrantesintermedia->fm_insertar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
    ...
    public function fc_actualizar()
    {
        ...
        $cinstagram = $this->input->get('vinstagram');
        $cgoogle = $this->input->get('vgoogle');
        $this->m_totalintegrantesintermedia->fm_actualizar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
        //echo json_encode(array('result' => 'guardado'));

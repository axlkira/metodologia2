...
class  C_diligenciarintegranteintermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_diligenciarintegranteintermediaLCV1');//carga el controlador modelo
        $this->load->model('m_capitulosintegranteintermediaLCV1');
...
//
    ...
    public function fc_diligenciarintegranteintermediaLCV1($page = 'v_diligenciarintegranteintermediaLCV1') {
       ...
       // $this->c_capitulosintegranteintermedia->fc_capitulosintegranteintermedia();
        ...
        $datosintegrante = $this->m_diligenciarintegranteintermediaLCV1->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $idinteexiste = $this->m_diligenciarintegranteintermediaLCV1->fm_foloexiste($idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $listartabla = $this->m_diligenciarintegranteintermediaLCV1->fm_listartabla($folio);
        ...
        if($valor->estadointeintermediaLC <> '1')
        {
        ...
        $resultado = $this->m_diligenciarintegranteintermediaLCV1->fm_estadofin($folio);
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_diligenciarintegranteintermediaLCV1'; // para el titulo de la vista en la pestaña
     ...
     public function fc_insertarcapintegrantesintermedia()
    {
       ...
       $this->m_diligenciarintegranteintermediaLCV1->fm_insertarcapintegrantesintermedia($cvfolio,$cvidintegrante);
    }
  ...
  /*  public function fc_insertar()
    {
        ...
        $this->m_diligenciarintegranteintermediaLCV1->fm_insertar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
    ...
    *//*
    ...
    public function fc_actualizar()
    {
        ...
        $cinstagram = $this->input->get('vinstagram');
        $cgoogle = $this->input->get('vgoogle');
        $this->m_diligenciarintegranteintermediaLCV1->fm_actualizar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
        //echo json_encode(array('result' => 'guardado'));
    ...
    */
    ...
    public function fc_cerrarpaso()
    {
       ...
       $this->m_diligenciarintegranteintermediaLCV1->fm_cerrarpaso($cfolio,$cidpaso,$cestado);
    }
    ...
    public function fc_validar(){
        ...
        $datosintegrante = $this->m_capitulosintegranteintermediaLCV1->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
...
//        inicio lista de cap 5
         ...
         $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap5iintermedia($idintegrante);
...
//        inicio lista de cap 7
        ...
        $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap7iintermedia($idintegrante);
...
//        inicio cap 8
        ...
        $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap8iintermedia($idintegrante);
...
//    fin cap8    
       ...
       $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap9liintermedia($idintegrante);
...
{                
 ...
 $datos8 .=  '<tr>'.'<td class="col-md-2"><button type="button" id="c9lp1a'.$valor->idintegrante.'" '.$habilitarboton3.' onclick="c9lp1('.$valor->folio.','.$valor->idintegrante.')" class="btn btn-'.$claseboton3.' btn-sm col-sm-8">'.$mensajebtn3.'</button></td>
        ...
        $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap9mintermedia($idintegrante);
...
//$datos11 .= 'GOONORREA';
 $datos11 .=  '<tr><td><button type="button" id="c9mp1a'.$valor->idintegrante.'" '.$habilitarboton11.' onclick="c9mp1('.$valor->folio.','.$valor->idintegrante.')" class="btn btn-'.$claseboton11.' btn-sm col-sm-9">'.$mensajebtn11.'</button></td>
       ...
       $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap9niintermedia($idintegrante);
...
$cap9n1 = $valor->c9p24intermedia <> '' && $valor->c9p25intermedia <> '' ;
 ...
 $datos12 .=  '<tr><td class="col-md-2"><button type="button" id="cnp1a'.$valor->idintegrante.'" '.$habilitarboton20.' onclick="cnp1('.$valor->folio.','.$valor->idintegrante.')" class="btn btn-'.$claseboton20.' btn-sm col-sm-7">'.$mensajebtn20.'</button></td>
        ...
        $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap9piintermedia($idintegrante);
...
$cap9p1 = $valor->c9p26intermedia <> '' &&  $valor->c9p27intermediao1 <> '' &&  $valor->c9p28intermediao1 <> '' && $valor->c9p29intermediao1 <> '';
 ...
 $datos10 .=  '<tr><td class="col-md-2"><button type="button" id="c9pp1a'.$valor->idintegrante.'" '.$habilitarboton8.' onclick="c9pp1('.$valor->folio.','.$valor->idintegrante.')" class="btn btn-'.$claseboton8.' btn-sm col-sm-7">'.$mensajebtn8.'</button></td>
        ...
        $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap9qiintermedia($idintegrante);
...
$cap9q1 = $valor->c9p30intermedia <> '' && $valor->c9p31intermedia <> '' && $valor->c9p32intermedia <> '' && $valor->c9p33intermedia <> '' && $valor->c9p34intermedia <> '' && $valor->c9p35intermediao1 <> '' && $valor->c9p36intermediao1 <> '';
 ...
 $datos13 .=  '<tr><td><button type="button" id="cqp1a'.$valor->idintegrante.'" '.$habilitarboton22.' onclick="cqp1('.$valor->folio.','.$valor->idintegrante.')" class="btn btn-'.$claseboton22.' btn-sm col-sm-9">'.$mensajebtn22.'</button></td>
        ...
        $listartabla = $this->m_capitulosintegranteintermediaLCV1->fm_listartablacap9riintermedia($idintegrante);
...
//        fin cap 9
    ...
    public function fc_actualizarestadoint() 
    {
        ...
        $this->m_capitulosintegranteintermediaLCV1->fm_actualizarint($cfolio,$cidintegrante,$cstadointe);
        
        
        
        $listartabla = $this->m_diligenciarintegranteintermediaLCV1->fm_listartabla($cfolio);

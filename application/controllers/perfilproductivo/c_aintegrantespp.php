...
class  C_aintegrantespp extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('perfilproductivo/m_aintegrantespp');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_aintegrantespp($page = 'v_aintegrantespp') {
        ...
        $datosintegrante = $this->m_aintegrantespp->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $idinteexiste = $this->m_aintegrantespp->fm_foloexiste($idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $titular = $this->m_aintegrantespp->fm_buscartitular($folio);//lo mandasmos a la funcion del modelo para verificar
        ...
        $listatipodocumen = $this->m_aintegrantespp->fm_listartipodocumento();
        ...
        $datos .= '<option value="'.$documento->tipodocumento.'">'.$documento->tipodocumento.'</option>'; //se guarda el resultado del ption value en la variable datos
         ...
         $listasexo = $this->m_aintegrantespp->fm_listarsexo();
        ...
        $listarpaises = $this->m_aintegrantespp->fm_listarpaises();
        ...
        foreach ($listarpaises as $valpaises)
        {
            ...
            $paises .='<option value="'.$valpaises->nombrepais.'">'.$valpaises->nombrepais.'</option>'; 
                ...
                $listaretnias = $this->m_aintegrantespp->fm_listaretnia();
                ...
                $listarOsexual = $this->m_aintegrantespp->fm_listarOsexual();
                ...
                $listarIgenero = $this->m_aintegrantespp->fm_listarIgenero();
        ...
        ///////////// inicio nuevas variables ////////
                ...
                $listarSino = $this->m_aintegrantespp->fm_listarSino();
                $SiNo= '';
                ...
                $listarTipoE = $this->m_aintegrantespp->fm_listarTipoE();
                $TipoE= '';
                ...
                $listarBarreraA = $this->m_aintegrantespp->fm_listarBarreraA();
                $BarreraA= '';
                ...
                $idinteexistepp = $this->m_aintegrantespp->fm_integrantepp($idintegrante);//lo mandasmos a la funcion del modelo para verificar
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_aintegrantespp'; // para el titulo de la vista en la pestaña
        $this->load->view('pages/perfilproductivo/' . $page,  array('titulo' => $titulo, 'foot' => FOOTS, 'head44' => HEAD44, 'botonerag' => BOTONERAG, 'botoneraa' => BOTONERAA, 'datos'=> $datos, 'datos2' => $datos2, 'folio' => $folio,'idintegrante'=>$idintegrante, 'foexiste' =>$foexiste, 'tdatinte' => $tdatinte, 'dtitular'=> $dtitular, 'doccogestor'=> $doccogestor,'idestacion'=> $idestacion,'paises' => $paises
...
//        
//        
//        $this->m_aintegrantespp->fm_insertar($cfolio,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle);
...
//    }
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_aintegrantespp->fm_actualizar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle,$cnacionalidadv
    ...
    public function fc_eliminar()
   {
       ...
       $this->m_aintegrantespp->fm_eliminar($cfolio,$cidintegrante);
       //echo json_encode(array('result' => 'guardado'));
    ...
    public function fc_listarnacionalidad()
    {
          ...
          $listasino = $this->m_aintegrantespp->fm_listarnacionalidad($cdocumento);
          $barrios = '';

...
class  C_ppc1p3n2o2 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('/perfilproductivo/m_ppc1p3n2o2');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_ppc1p3n2o2($page = 'v_ppc1p3n2o2') {
        ...
        $cayudas = $this->m_ppc1p3n2o2->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_ppc1p3n2o2->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_ppc1p3n2o2->fm_buscarpregunta($idintegrante);
        ...
        $listararea = $this->m_ppc1p3n2o2->fm_listarareaconocimiento();
        $areas = '';
       ...
       //Levantar vista     
        $titulo = 'Cap I - Otro titulo obtenido(2)'; // para el titulo de la vista en la pestaña
        $this->load->view('pages/perfilproductivo/' . $page,  array('titulo' => $titulo, 
                                                   'foot' => FOOTS, 
                                                   'head' => HEAD, 
                                                   'botonerag' => BOTONERAG, 
                                                   'botoneraa' => BOTONERAA,
                                                   'botoneragotro2' => BOTONERAGOTRO2, 
                                                   'botoneraaotro2' => BOTONERAAOTRO2,
                                                   'folio' => $cfolio,
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_ppc1p3n2o2->fm_actualizarpregunta($cfolio,$cidintegrante,$cvalorppc1p3n2,$cppc1p3n5institucion,$cppc1p3n5area,$cppc1p3n6,$cppc1p3n7);
    ...
    public function fc_eliminar()
    {
        ...
        $this->m_ppc1p3n2o2->fm_eliminar($cfolio,$cidintegrante);
       //echo json_encode(array('result' => 'guardado'));
    }

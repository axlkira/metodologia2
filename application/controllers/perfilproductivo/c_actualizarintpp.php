...
class  C_actualizarintpp extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('/perfilproductivo/m_actualizarintpp');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_actualizarintpp($page = 'v_actualizarintpp') {
        ...
        $datosintegrante = $this->m_actualizarintpp->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $idinteexiste = $this->m_actualizarintpp->fm_foloexiste($idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $listartabla = $this->m_actualizarintpp->fm_listartabla($folio);
        ...
        $datos .=  '<tr>'
                ...
                //.'<td><button type="button" id="edicion" class="btn btn-success btn-sm">Editar</button></td>
                   .'<td><button type="button" id="edicion'.$valor->idintegrante.'" onclick="edicionintepp('.$valor->folio.','.$valor->idintegrante.')" class="btn btn-success btn-sm">Editar</button></td>
       ...
       //ESTO LEVANTA LA VISTA     
        ...
        $this->load->view('pages/perfilproductivo/' . $page,  array('titulo' => $titulo, 'foot' => FOOTS, 'head44' => HEAD44, 'botonerag' => BOTONERAG, 'botoneraa' => BOTONERAA, 'datos'=> $datos,  'folio' => $folio,'doccogestor' => $doccogestor, 'foexiste' =>$foexiste, 'tdatinte' => $tdatinte,'idestacion' => $idestacion));

...
class  C_ppc1p4n1o2 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('/perfilproductivo/m_ppc1p4n1o2');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_ppc1p4n1o2($page = 'v_ppc1p4n1o2') {
        ...
        $cayudas = $this->m_ppc1p4n1o2->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_ppc1p4n1o2->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_ppc1p4n1o2->fm_buscarpregunta($idintegrante);
       ...
       //Levantar vista     
        $titulo = 'Cap I - Otros Estuduios(2)'; // para el titulo de la vista en la pestaña
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_ppc1p4n1o2->fm_actualizarpregunta($cfolio,$cidintegrante,$cvalorppc1p4n1estudio,$cppc1p4n2,$cppc1p4n3,$cppc1p4n4,$cppc1p4n5);
    ...
    public function fc_eliminar()
    {
        ...
        $this->m_ppc1p4n1o2->fm_eliminar($cfolio,$cidintegrante);
       //echo json_encode(array('result' => 'guardado'));
    }

...
class  C_ppactualizar extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('/perfilproductivo/m_ppactualizar');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_ppactualizar($page = 'v_ppactualizar') {
...
//        $idintegrante = $this->input->get('idintegrante');
        ...
        $cayudas = $this->m_ppactualizar->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_ppactualizar->fm_cargardatosgenerales($cfolio);
        ...
        $crespuestas = $this->m_ppactualizar->fm_buscarpregunta($cfolio,$cidestacion);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_ppactualizar->fm_actualizarpregunta($cfolio,$cestacion,$cactualizo);
    ...
    public function fc_cerrarpaso()
    {
       ...
       $this->m_ppactualizar->fm_cerrarpaso($cfolio,$cidpaso,$cestado);
    }

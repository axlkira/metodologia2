...
/////////////// NUEVO LOGIN ///////////////////////////
class C_dimensionespLCV1 extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('/privacionesintermediaLCV1/m_dimensionespLCV1');
    }

     //funcion encargada de llamar a la vista de la pagina 
    public function fc_dimensionespLCV1($page = 'v_dimensionespLCV1') {

        if (!file_exists('application/views/pages/privacionesintermediaLCV1/'. $page . '.php')) {
        ...
        $datosintegrante = $this->m_dimensionespLCV1->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $folioexiste = $this->m_dimensionespLCV1->fm_folioexiste($folio);//lo mandasmos a la funcion del modelo para verificar
        ...
        $matrizgrados = $this->m_dimensionespLCV1->fm_matrizgraduacion($folio);//lo mandasmos a la funcion del modelo para verificar
...
//fin matriz graduacion
        $listarprivacion = $this->m_dimensionespLCV1->fm_listartablaprivaciones();
        ...
        {  
           $calcularprivacion = $this->m_dimensionespLCV1->fm_calcularprivacion($folio,$privacion->idprivacion); 

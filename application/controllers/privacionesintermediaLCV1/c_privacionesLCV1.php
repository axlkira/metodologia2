...
/////////////// NUEVO LOGIN ///////////////////////////
class C_privacionesLCV1 extends CI_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('/privacionesintermediaLCV1/m_privacionesLCV1');
    }

     //funcion encargada de llamar a la vista de la pagina 
    public function fc_privacionesLCV1($page = 'v_privacionesLCV1') {
      ...
      //  $idintegrante = $this->input->get('idintegrante');
        ...
        $folioexiste = $this->m_privacionesLCV1->fm_folioexiste($folio);//lo mandasmos a la funcion del modelo para verificar
       ...
       // $listalogro = $this->m_privaciones->fm_privacionresultado($folio,$idlogro);
        $listaprivacion = $this->m_privacionesLCV1->fm_privacionresultado($folio,$idprivacion);
        $privacionresul = ''; 
        // $colorlogroint = ''; 
        $bolitaint = '';
        $tabla = '';
...
//        fin armar tabla
       ...
       //ESTO LEVANTA LA VISTA     
        ...
        $this->load->view('pages/privacionesintermediaLCV1/'.$page,  array('titulo' => $titulo, 'foot' => FOOTS, 'head' => HEAD1, 'botoneral' => BOTONERALOGROS, 'privacion' => $privacionresul, 'folio' => $folio, 'doccogestor' => $doccogestor, 'foexiste' =>$foexiste, 'iddimen' => $iddimension, 'idpriva' => $idprivacion,'tabla' => $tabla,'colordimen' => $colordimension,'cidestacion' => $cidestacion));

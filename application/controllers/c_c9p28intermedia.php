...
class  C_c9p28intermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p28intermedia');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p28intermedia($page = 'v_c9p28intermedia') {
        ...
        $cayudas = $this->m_c9p28intermedia->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p28intermedia->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p28intermedia->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p28intermedia->fm_actualizarpregunta($cfolio,$cidintegrante,$cc9p28intermediao1,$cc9p28intermediao1cuanto,$cc9p28intermediao2,$cc9p28intermediao2cuanto,$cc9p28intermediao3,$cc9p28intermediao3cuanto,

...
class  C_c2p1intermediaLCV1 extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c2p1intermediaLCV1');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c2p1intermediaLCV1($page = 'v_c2p1intermediaLCV1') {
        ...
        $cayudas = $this->m_c2p1intermediaLCV1->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c2p1intermediaLCV1->fm_cargardatosgenerales($cfolio);
        ...
        $crespuestas = $this->m_c2p1intermediaLCV1->fm_buscarpregunta($cfolio);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c2p1intermediaLCV1->fm_actualizarpregunta($cfolio,$cvalorc2p1intermedia,$cvalorc2p1intermediacual);

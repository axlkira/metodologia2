...
class  C_integrantesintermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_integrantesintermedia');//carga el controlador modelo
    ...
    public function fc_integrantesintermedia($page = 'v_integrantesintermedia') {
        ...
        $datosintegrante = $this->m_integrantesintermedia->fm_datosintegrante($folio,$idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $idinteexiste = $this->m_integrantesintermedia->fm_foloexiste($idintegrante);//lo mandasmos a la funcion del modelo para verificar
        ...
        $titular = $this->m_integrantesintermedia->fm_buscartitular($folio);//lo mandasmos a la funcion del modelo para verificar
        ...
        $listatipodocumen = $this->m_integrantesintermedia->fm_listartipodocumento();
        ...
        $datos .= '<option value="'.$documento->tipodocumento.'">'.$documento->tipodocumento.'</option>'; //se guarda el resultado del ption value en la variable datos
         ...
         $listasexo = $this->m_integrantesintermedia->fm_listarsexo();
        ...
        $listarpaises = $this->m_integrantesintermedia->fm_listarpaises();
        ...
        $listaretnias = $this->m_integrantesintermedia->fm_listaretnia();
        ...
        $listarOsexual = $this->m_integrantesintermedia->fm_listarOsexual();
        ...
        $listarIgenero = $this->m_integrantesintermedia->fm_listarIgenero();
...
///////////// inicio nuevas variables ////////
       ...
       //ESTO LEVANTA LA VISTA     
        $titulo = 'v_integrantesintermedia'; // para el titulo de la vista en la pestaña
    ...
    public function fc_insertar()
    {
        ...
        $this->m_integrantesintermedia->fm_insertar($cfolio,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle,$cdocumentocog,$cnacionalidadv
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_integrantesintermedia->fm_actualizar($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$cfnacimiento,$csexo,$cedad,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle,$cnacionalidadv
        ,$cetnias,$cOsexual,$cIgenero);
        //echo json_encode(array('result' => 'guardado'));
    ...
    public function fc_actualizarsincalculo()
    {
        ...
        $cgoogle = $this->input->get('vgoogle');
        $cnacionalidadv = $this->input->get('vnacionalidadv');
        $this->m_integrantesintermedia->fm_actualizarsincalculo($cfolio,$cidintegrante,$ctdocumento,$cndocumento,$cpnombre,$csnombre,$cpapellido,$csapellido,$ctelefono,$ccelular,$ccorreo,$ctwitter,$cfacebook,$cinstagram,$cgoogle,$cnacionalidadv);
        //echo json_encode(array('result' => 'guardado'));
    ...
    public function fc_eliminar()
   {
       ...
       $this->m_integrantesintermedia->fm_eliminar($cfolio,$cidintegrante);
       //echo json_encode(array('result' => 'guardado'));
...
//    }
     ...
     public function fc_listarnacionalidad()
     {
           ...
           $listasino = $this->m_integrantesintermedia->fm_listarnacionalidad($cdocumento);
           $barrios = '';

...
class  C_c9p38intermedia extends CI_Controller {

    public function __construct() {
        parent::__construct();
        $this->load->helper('url');
        $this->load->library('session');
        $this->load->model('m_c9p38intermedia');//carga el controlador modelo
    }

    //funcion encargada de llamar a la vista de la pagina 
    public function fc_c9p38intermedia($page = 'v_c9p38intermedia') {
        ...
        $cayudas = $this->m_c9p38intermedia->fm_ayudas();
        $ctextoayuda = '';
        ...
        $cdatosgenerales = $this->m_c9p38intermedia->fm_cargardatosgenerales($cfolio,$idintegrante);
        ...
        $crespuestas = $this->m_c9p38intermedia->fm_buscarpregunta($idintegrante);
    ...
    public function fc_actualizar()
    {
        ...
        $this->m_c9p38intermedia->fm_actualizarpregunta($cfolio,$cidintegrante,$cvc9p38intermediao1,$cvc9p38intermediao2,$cvc9p38intermediao3,$cvc9p38intermediao4,$cvc9p38intermediao5,$cvc9p38intermediao6,
                                              $cvc9p38intermediao7,$cvc9p38intermediao8,$cvc9p38intermediao9,$cvc9p38intermediao10,$cvc9p38intermediacual);

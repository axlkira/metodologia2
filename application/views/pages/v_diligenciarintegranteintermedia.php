...
//        
           ...
           $("#continuarintegrante").click(function ()
                {
                  location.href = "../c_capitulosintegranteintermedia/fc_capitulosintegranteintermedia?folio="+ $('#foliodiligenciainte').val() +"&idintegrante=" + $('#ideintediligenciainte').val();      
       ...
       //
                ...
                {
                // alert('juapis');
                location.href = "../c_totalintegrantesintermedia/fc_totalintegrantesintermedia?folio="+ $('#folio').val() +"&idintegrante=0" + "&variable=81";                  
                });

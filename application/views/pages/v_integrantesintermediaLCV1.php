...
<!-- fin head            -->
                ...
                <div  class="row">
                    ...
                    <p class="text-right"><small>Te encuentras en la opción para el <strong>INGRESO DE NUEVOS INTEGRANTES</strong></small></p><br>
...
<!--para imprimir el folio y llevarlo-->
                        ...
                        <input type="text" class="form-control input-sm" id="documentocog" name="documentocog" style="display:none"  value="<?php echo($documentocog);?>">
<!--fin para imprimir el folio y llevarlo  $documentocog -->
...
<!--opcion de seleccion-->
                   <div class="row">
                    ...
                    <label class="control-label">Nacionalidad</label>
                       ...
                       <div  id="ndocumentodiv" name="ndocumentodiv" <?php if($foexiste['etipodocumento']=='No tiene'){echo('class="form-group col-md-4 form-group-sm" style="display: none"');}else if($foexiste['edocumento']==''){echo('class="form-group col-md-4 form-group-sm has-error"');}else if ( $foexiste['edocumento']=='98'){echo ('class="form-group col-md-4 form-group-sm" style="display: none"'); }{echo('class="form-group col-md-4 form-group-sm"');}?>>
                       ...
                       <input type="text" class="form-control input-sm" on id="snombre"  name="snombre" onkeypress="return soloLetras(event)"  placeholder="Segundo Nombre" value="<?php echo($foexiste['enombre2']); ?>">
                       </div>
                       ...
                       <input type="text" class="form-control input-sm"  id="sapellido" name="sapellido" onkeypress="return soloLetras(event)"  placeholder="Segundo Apellido" value="<?php echo($foexiste['eapellido2']); ?>">
                       </div>
                   </div><br>
<!--fin de seleccion-->
...
<!--inicio radio una sola seleccion-->
    <div class="row">
        <div  id="fnacimientodiv" name="fnacimientodiv" <?php if($foexiste['efnacimiento']==''){echo('class="form-group col-md-2 form-group-sm has-error "');}else{echo('class="form-group col-md-2 form-group-sm"');}?>>
         ...
         <input type="date" class="form-control input-sm" id="fnacimiento" onchange="enviarnumjp()" name="fnacimiento" onblur="calcularfecha(this.value)"   value="<?php  echo($foexiste['efnacimiento']); ?>">
        </div>
        ...
        <div  id="edaddiv" name="edaddiv" class="form-group col-md-2 form-group-sm">
         ...
         <input type="text" class="form-control input-sm" id="telefono" maxlength="10" onblur="validarcantdigitosfijo('telefono','telefonodiv')" name="telefono" onkeypress="return soloNumeros(event)" placeholder="ingrese número telefónico"   value="<?php  echo($foexiste['etelefono']); ?>">
         </div>
         ...
         <input type="text" class="form-control input-sm" id="celular" maxlength="10" onblur="validarcantdigitos('celular',10,'celulardiv')" name="celular" onkeypress="return soloNumeros(event)"  placeholder="ingrese celular" value="<?php  echo($foexiste['ecelular']); ?>">
         </div>
        
         <div  id="correodiv" name="correodiv" class="form-group col-md-2 form-group-sm">
         <label class="control-label">Correo Electronico</label>
         <input type="email" class="form-control input-sm" id="correo" name="correo" onchange="validarbolitasytexto('correodiv','correo')" placeholder="Ingrese correo electronico" value="<?php  echo($foexiste['ecorreo']); ?>">
         </div>
...
//    function insertarintegrante_intermedia()
//    {
//       $.ajax({
//                          url: "fc_insertarintegranteintermedia",
//                          type: "GET",
//                           data: {
//                                vfolio : $('#folio').val()
//                               ,vidintegrante : $('#idintegrante').val()
//                               ,documentocog : $('#documentocog').val()},
//                          dataType: "html",
                ...
                $("#guardar").click(function ()
                {
                        ...
                        $.ajax({
                          ...
                          data: {vfolio : $('#folio').val(), vtdocumento : $('#tdocumento').val(),vndocumento : $('#ndocumento').val(),vpnombre : $('#pnombre').val(),vsnombre : $('#snombre').val(),vpapellido : $('#papellido').val(),vsapellido : $('#sapellido').val(),
                              vfnacimiento : $('#fnacimiento').val(),vsexo : $('#sexo').val(),vedad : $('#edad').val(),vtelefono : $('#telefono').val(),vcelular : $('#celular').val(),vcorreo : $('#correo').val(),vtwitter : $('#twitter').val(),vfacebook : $('#facebook').val(),vinstagram: $('#instagram').val(),vgoogle : $('#google').val(),vdocumentocog : $('#documentocog').val(),vnacionalidadv : $('#nacionalidadv').val(),
                              vetnias: $('#etnias').val(),
                          ...
                          if($('#variable').val() == 90){
								location.href = "../c_totalintegrantesintermediaLCV1/fc_totalintegrantesintermediaLCV1?folio="+ $('#folio').val() +"&idintegrante=0"+"&variable="+$('#variable').val();  
								
							}else{
                        location.href = "../c_totalintegrantesintermedia/fc_totalintegrantesintermedia?folio="+ $('#folio').val() +"&idintegrante=0"; //$('#datos').html(obj);
                          }
                      }
                        });                    
                });
                    ...
                    $.ajax({
                          ...
                          type: "GET",
                           data: {vfolio : $('#folio').val(), vidintegrante : $('#idintegrante').val(),vtdocumento : $('#tdocumento').val(),vndocumento : $('#ndocumento').val(),vpnombre : $('#pnombre').val(),vsnombre : $('#snombre').val(),vpapellido : $('#papellido').val(),vsapellido : $('#sapellido').val(),
                              vfnacimiento : $('#fnacimiento').val(),vsexo : $('#sexo').val(),vedad : $('#edad').val(),vtelefono : $('#telefono').val(),vcelular : $('#celular').val(),vcorreo : $('#correo').val(),vtwitter : $('#twitter').val(),vfacebook : $('#facebook').val(),vinstagram: $('#instagram').val(),vgoogle : $('#google').val(),vnacionalidadv : $('#nacionalidadv').val(),
                              vetnias: $('#etnias').val(),
                              vOsexual: $('#Osexual').val(),
                              vIgenero: $('#Igenero').val()},
                          dataType: "html",
              ...
              /*        if (banderaactualizar == 1)
                      ...
                      {  
                       $.ajax({
                          ...
                          type: "GET",
                           data: {vfolio : $('#folio').val(), vidintegrante : $('#idintegrante').val(),vtdocumento : $('#tdocumento').val(),vndocumento : $('#ndocumento').val(),vpnombre : $('#pnombre').val(),vsnombre : $('#snombre').val(),vpapellido : $('#papellido').val(),vsapellido : $('#sapellido').val(),
                              vtelefono : $('#telefono').val(),vcelular : $('#celular').val(),vcorreo : $('#correo').val(),vtwitter : $('#twitter').val(),vfacebook : $('#facebook').val(),vinstagram: $('#instagram').val(),vgoogle : $('#google').val(),vnacionalidadv : $('#nacionalidadv').val()},
                          dataType: "html",
                          success : function(obj){                      
                          okactualizar();//me llama el mensajito de actualizar
                            //$('#datos').html(obj);
...
//                          okactualizar();//me llama el mensajito de actualizar
                            //$('#datos').html(obj);
							if($('#variable').val() == 81){
								location.href = "../c_totalintegrantesintermediaintermedia/fc_totalintegrantesintermediaintermedia?folio="+ $('#folio').val() +"&idintegrante=0"+"&variable="+$('#variable').val();  
								
							}else{
							
                          location.href = "../c_totalintegrantesintermedia/fc_totalintegrantesintermedia?folio="+ $('#folio').val() +"&idintegrante=0";  
                          }
						  }
                        });                    
                });
                 ...
                 $("#cancelar").click(function ()
                {
                  ...
                  location.href = "../c_totalintegrantesintermediaLCV1/fc_totalintegrantesintermediaLCV1?folio="+ $('#folio').val() +"&idintegrante=0"+"&variable="+$('#variable').val(); //$('#datos').html(obj);

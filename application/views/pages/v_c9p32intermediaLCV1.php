...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
    $(document).ready(function()
    {
        ...
        {                           
         location.href = "../c_c9p33intermediaLCV1/fc_c9p33intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                      
    ...
    if(opcion == '1')
        {
           // alert('aca lo muestra');
            $('#c9p32intermediacualdivmostrar').show();
        ...
        {
            //alert('aca lo oculta');
            $('#c9p32intermediacualdivmostrar').hide();

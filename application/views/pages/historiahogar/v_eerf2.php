...
<body>  
    <div class="container">
        ...
        <input type="text" class="form-control input-sm" id="cantidaderfam2" name="cantidaderfam2" style="display: none"  placeholder="Text input" value="<?php echo($eerf); ?>">
                      ...
                      <div class="modal-dialog modal-sm">
                        <div class="modal-content">
                            <div class="modal-header">
                                <h4 class="modal-title" id="myModalLabel"><img src="<?php echo IMAGEN, 'cargando.gif'; ?>" alt="Brand"> Guardando la información</h4>
                            </div>
                            <div class="modal-body">
...
cargardatosgenerales('<?php echo('Historia del hogar'); ?>','Aplicacion ERFAM','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['etitular']); ?>','100');

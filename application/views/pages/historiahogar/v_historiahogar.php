...
<body>  
    <div class="container">
        ...
        <input type="text" class="form-control input-sm" id="historiacont" style="display:none" value="<?php echo($historiacont); ?>">
        <input type="text" class="form-control input-sm" id="procedecont" style="display:none" value="<?php echo($procedecont); ?>">
        <input type="text" class="form-control input-sm" id="costumbrescont" style="display:none" value="<?php echo($costumbrescont); ?>">
        <input type="text" class="form-control input-sm" id="logroscont" style="display:none" value="<?php echo($logroscont); ?>">
...
<!-- Modal inicio-->
<div class="modal fade" id="modalConformacionhogar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">1. ¿Cómo está Conformado el hogar?</h5>
        </div>
      <div class="modal-body">
      Debe ingresar por lo menos un registro en este ítem para poder continuar.
      </div>
      <div class="modal-footer">
...
<!-- modal fin-->
<!-- Modal inicio-->
<div class="modal fade" id="modalProcedehogar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">2. ¿De dónde Procede el hogar?</h5>
        </div>
      <div class="modal-body">
      Debe ingresar por lo menos un registro en este ítem para poder continuar.
      </div>
...
<!-- modal fin-->
<!-- Modal inicio-->
<div class="modal fade" id="modalCostumbreshogar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">3. ¿Cuáles son las Principales Costumbres y características del hogar?</h5>
        </div>
      <div class="modal-body">
      Debe ingresar por lo menos un registro en este ítem para poder continuar.
      </div>
...
<!-- modal fin-->
<!-- Modal inicio-->
<div class="modal fade" id="modallogroshogar" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true" data-keyboard="false" data-backdrop="static">
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title" id="exampleModalLabel">4. ¿Qué nos hace orgullosos de nuestro hogar?</h5>
        </div>
      <div class="modal-body">
      Debe ingresar por lo menos un registro en este ítem para poder continuar.
      </div>
...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
    $(document).ready(function()
    {
        ...
        {
         if($('#historiacont').val() == 0){
         $('#modalConformacionhogar').modal();
         }else if($('#procedecont').val() == 0){
          $('#modalProcedehogar').modal();
         }else if($('#costumbrescont').val() == 0){
          $('#modalCostumbreshogar').modal();
         }else if($('#logroscont').val() == 0){
          $('#modallogroshogar').modal();
         }else{
...
cargardatosgenerales('<?php echo('Historia hogar'); ?>','Vista 1 de 7','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['etitular']); ?>','14');
...
function guardarlogros()
{
    //alert('hola logros');
                        ...
                        $.ajax({
                          ...
                          type: "POST",
                          data: {vfolio : $('#folio').val(), vtextlogro : $('#textlogros').val(), vestacion : 'E0'},    
                          dataType: "json",
                          success : function(obj){
                          $('#collapseCuatro').html(obj.carraydatoshflogros);   
                          $('#logroscont').val(obj.logroscont); 
                          botonactualizar();
                          $('#textlogros').val('');
...
function guardarconformacion()
{
    //alert('hola logros');
                        ...
                        $.ajax({
                          ...
                          type: "POST",
                          data: {vfolio : $('#folio').val(), vtextconformacion : $('#textconformacion').val(), vestacion : 'E0'},    
                          dataType: "json",
                          success : function(obj){
                          $('#collapseOne').html(obj.carraydatoshfconformacion); 
                          $('#historiacont').val(obj.historiacont);   
                          botonactualizar();
...
function guardarprocedencia()
{
                        $.ajax({
                          ...
                          type: "POST",
                          data: {vfolio : $('#folio').val(), vtextprocedencia : $('#textprocedencia').val(), vestacion : 'E0'},    
                          dataType: "json",
                          success : function(obj){
                          $('#collapseTwo').html(obj.carraydatoshfprocedencia); 
                          $('#procedecont').val(obj.procedecont);   
                          botonactualizar();
                          $('#textprocedencia').val('');
...
function guardarcostumbres()
{
    //alert('hola logros');
                        $.ajax({
                          ...
                          type: "POST",
                          data: {vfolio : $('#folio').val(), vtextconstumbres : $('#textcostumbres').val(), vestacion : 'E0'},    
                          dataType: "json",
                          success : function(obj){
                          $('#collapseThree').html(obj.carraydatoshfconstumbres);  
                          $('#costumbrescont').val(obj.costumbrescont);  
                          botonactualizar();
                          $('#textcostumbres').val('');

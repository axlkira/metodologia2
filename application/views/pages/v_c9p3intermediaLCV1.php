...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','1 de 2 subcapitulo 9L','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','50');
...
if($('#valorc9p3intermedia').val() === 'c9p3intermediao1')
         {                
                          $.ajax({
                          url: "../c_c9p4intermediaLCV1/fc_actualizar",
                          type: "GET",
    ...
    if(opcion == 'c9p3intermediao6')
        {
           // alert('aca lo muestra');
            $('#c9p3intermediacualmostrar').show();
        ...
        {
            //alert('aca lo oculta');
            $('#c9p3intermediacualmostrar').hide();

...
<html lang="es">
    ...
    <div class="container" id="acordeon">
            ...
            <table><h2>Vista de las dimensiones que tienen privaciones:</h2>
                   <h3>Resultado después de realizar  la visita intermedia de la línea de cierre.</h3>
                <tr>
                <td><h4>folio: <?php echo($folio);?></h4>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">Ver Matriz de Graduación del Formulario Intermedia de la línea de cierre</button>
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="exampleModalLabel">Matriz de Graduación de Intermedia de la línea  de cierre</h4>
                      </div>
...
$("#anterior").click(function ()
        ...
        {
        location.href = "../../c_protocolocierreadmin/fc_protocolocierreadmin?folio=" + $('#folio').val()+ "&idintegrante="+"&idintegrante=0";                    
        }
        else
        {
...
function iravista(folio,iddimen,idpriv,idestacion)
    ...
    // alert('folio' + folio + 'iddimension' + iddimen + 'logro' + idlog + 'color dimension' + colordimension );
      ...
      location.href = "../c_privacionesLCV1/fc_privacionesLCV1?folio="+ folio +"&iddimension="+iddimen +"&idprivacion="+idpriv+"&colordimension="+colordimension+"&idestacion="+idestacion;

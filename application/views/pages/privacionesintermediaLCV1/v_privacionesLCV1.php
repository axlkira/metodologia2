...
<html lang="es">
    ...
    <body> 
        ...
        <div class="container">
            ...
            <!--head            -->
            <?php echo($head); ?><br>
            <input type="text" class="form-control input-sm" id="idestacion" name="idestacion" style="display:" value="<?php echo($cidestacion); ?>">
                ...
                <div class="row">
                    <div class="form-group form-group-sm">   
                        <div class="form-group  ">
                           ...
                           <div class="panel-heading"><h2>Resultado del cálculo de privaciones de la visita intermedia de la línea de cierre.</h2>
                           <h2>Información por hogar e integrantes del folio: <?php echo($folio);?></h2></div>
...
$("#anterior").click(function ()
        {
            location.href = "../c_dimensionespLCV1/fc_dimensionespLCV1?folio=" + $('#folio').val()+"&idintegrante=0"+"&idestacion="+<?php echo($cidestacion); ?>;                    
        });

...
<html lang="es">
    ...
    <div class="container" id="acordeon">
            ...
            <table><h3>Vista de las dimensiones que tienen privaciones</h3>
                <tr>
                <td><h4>folio: <?php echo($folio);?></h4>
                <button type="button" class="btn btn-primary" data-toggle="modal" data-target="#exampleModal" data-whatever="@getbootstrap">Ver Matriz de Graduación</button>
                <div class="modal fade" id="exampleModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel">
                  <div class="modal-dialog" role="document">
                    <div class="modal-content">
                      <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
                        <h4 class="modal-title" id="exampleModalLabel">Matriz de Graduación</h4>
                      </div>
...
$("#anterior").click(function ()
        {
        location.href = "../c_dimensionespseleccion/fc_dimensionespseleccion?folio="+ $('#folio').val() +"&idintegrante=0"+"&doccogestor="+ $('#doccogestor').val();    
        });
...
function iravista(folio,iddimen,idpriv)
    { 
        if (iddimen == '2')
        {

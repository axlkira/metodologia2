...
<hr>
        <form class="form-group" name="formulario" id="formulario">
            ...
            <div class="row">
            <div id="c9p26intermediadiv" name="c9p26intermediadiv" <?php if($arrayrespuestas['ec9p26intermedia']==''){echo('class="form-group col-md-12 form-group-sm has-error"');}else{echo('class="form-group col-md-12 form-group-sm"');}?>>   
                ...
                <div class="radio">
                    <label><!--en este caso se manda a la fincion javascript el valor del campo-->
                        <input type="radio" name="c9p26intermedia" id="c9p26intermedia" onclick="colocaropcion('1','valorc9p26intermedia','c9p26intermediadiv');" value="1" <?php if($arrayrespuestas['ec9p26intermedia']=='1'){echo('checked');}?>>
                        Si
                    </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" name="c9p26intermedia" id="c9p26intermedia" onclick="colocaropcion('2','valorc9p26intermedia','c9p26intermediadiv');" value="2" <?php if($arrayrespuestas['ec9p26intermedia']=='2'){echo('checked');}?>>
                        No
                    </label>             
                </div> 
                <input type="text" class="form-control" id="valorc9p26intermedia" name="valorc9p26intermedia" style="display:none" placeholder="Text input" value="<?php echo($arrayrespuestas['ec9p26intermedia']); ?>">
            </div>
            </div> 
            ...
            <?php if($arrayrespuestas['ec9p26intermedia']=="")
            {
                echo($botoneraginter);
            }
            else
    ...
    $(document).ready(function()
    {
        ...
        $("#guardar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),vidintegrante : $('#idintegrante').val(), vvalorc9p26intermedia : $('#valorc9p26intermedia').val()},    
                          dataType: "html",
        ...
        {
        if($('#valorc9p26intermedia').val() === '2')
        {
        location.href = "../c_c9p28intermediaLCV1/fc_c9p28intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                         
        } 
        else
        {
         location.href = "../c_c9p27intermediaLCV1/fc_c9p27intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                     
        }                  
        ...
        $("#anterior").click(function ()
        {
            ...
            if($('#c9p8').val() == 'c9p8intermediao7' || $('#c9p8').val() == 'c9p8intermediao6' )
        {
        ...
        else if($('#c9p3').val() === 'c9p3intermediao5' && $('#c9p4').val() === '2' )
        {
...
function salto26()
{
    if($('#valorc9p26intermedia').val() === '2')
         {                
                          ...
                          $.ajax({
                          url: "../c_c9p27intermediaLCV1/fc_actualizar",
                          type: "GET",
         ...
         else if (($('#valorc9p26intermedia').val() === '1' ))
         {               

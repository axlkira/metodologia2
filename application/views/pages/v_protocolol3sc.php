...
<!-- fin head            -->
                ...
                <div  class="row">
                    ...
                    <h3 class="text-right col-md-12"><small>Te encuentras en <strong>(L3) Línea de Promoción</strong></small></h3>
...
<!--para imprimir el folio y llevarlo-->
                        ...
                        <input type="text" class="form-control input-sm" style="display: none" value="<?php echo($midestacion31['folio']); ?>">
<!--fin para imprimir el folio y llevarlo-->
                ...
                <form class="form-group" class="form-group col-md-offset-1" name="formulario" id="formulario">
                    ...
                    <h1 class="panel-title"><span class="badge">Sesión de cierre</span></h1>
                    </div>
                    <div class="panel-body  text-justify">
                     Momento para orientar la promoción del hogar del proyecto Familia Medellín-Medellín Solidaria a partir del reconocimiento de las metas alcanzadas, logros alcanzados en las nueve Dimensiones del Desarrollo Humano, fortalecimiento de relaciones familiares y en general el mejoramiento de sus condiciones de vida de acuerdo con las mediciones establecidas por el proyecto.             
                    </div>
                    </div>
                    </div>
<!-- ////////////////////////////////////////////////// nuevo ////////////////////////////////////////////-->
...
<!-- /////////////////////////////////////////////////////////////////// fin nuevo ////////////////////////////////////// -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking" id="modpaso1" <?php if (($midpaso['maximoidpaso']=='2208' && $tdatidvisita['tfolio'] <> '')|| ($midpaso['maximoidpaso']=='2310' && $tdatidvisita['tfolio'] <> '') || ($midpaso['maximoidpaso']=='2609' && $tdatidvisita['tfolio'] <> '') || ($midpaso['maximoidpaso']=='2807' && $tdatidvisita['tfolio'] <> '')){}else{echo 'disabled';}?>>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso1('3101');" name=cerrar1 id=cerrar1 class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking2" id="modpaso2" <?php if($midpaso['maximoidpaso']=='3101') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso2('3102');" name=cerrar2 id=cerrar2 class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking3" id="modpaso3" <?php if($midpaso['maximoidpaso']=='3102') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <h5 class="modal- text-justify" id="myModalLabel">El Gestor Territorial de Familia retoma los momentos del acompañamiento familiar, genera frente a la corresponsabilidad en la construcción y desarrollo del plan de vida familiar y en el fortalecimiento de sus relaciones familiares, recuerda las metas y logros alcanzados, pendientes por alcanzar y las capacidades presentes en todos los integrantes del hogar, igualmente invita a continuar de manera autónoma en la gestión de programas, proyectos o servicios necesarios para el mantenimiento y mejoramiento de sus condiciones de vida.  
 <br><br>
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso3('3103');" name=cerrar3 id=cerrar3 class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking4" id="modpaso4" <?php if($midpaso['maximoidpaso']=='3103') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 4</span> --- Explicación de la condición suficiente_ Pobreza Multidimensional (IPM)--- </p>
                            </button>
                        </div>
                    </div>
                    </div>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <h5 class="modal- text-justify" id="myModalLabel"> 
                                          ...
                                          <img src="<?php echo IMAGEN, 'ipm.png'; ?>">
                                            
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso4('3104');" name=cerrar4 id=cerrar4 class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button  class="btn btn-warning col-md-6 text-left" type="button" data-toggle="modal" data-target="#modalAddTracking5" id="modpaso5" <?php if($midpaso['maximoidpaso']=='3104') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 5</span> --- Aplicación ERFAM y estrategias de autonomía---</p>
                            </button>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso5('3105');" name=cerrar5 id=cerrar5 class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking6" id="modpaso6" <?php if($midpaso['maximoidpaso']=='3105') {echo ('enabled');} else {echo ('disabled');}?>>
                               <p class="text-left"><span class="badge">Paso 6</span> ------ Firma de formato -Cierre de la visita  ------</p>
                            </button>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                       <div class="panel-body  text-justify">
                     El Gestor Territorial de Familia procede con la firma del formato de sesión de cierre,  se despide de los integrantes presentes en la visita, reitera que es la última visita de acompañamiento familiar, agradece al hogar por responder positivamente a los compromisos asumidos y haber permitido el acompañamiento del proyecto Familia Medellín-Medellín Solidaria.
                                       </div>   
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso6('3106');" name="cerrar6" id="cerrar6" class="btn btn-warning" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
...
<!-- ////////////////////////////////////////////////// nuevo informativo////////////////////////////////////////////-->
 ...
 <div class="row">
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-20">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking0Accion" id="modpaso0Accion" <?php if ($midpaso['maximoidpaso'] < '3106' || $tdatidvisitaAccion['tfolio'] <> ''){echo 'disabled';}else {echo 'enabled';}?>>
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                           ...
                           <?php if($tdatidvisitaAccion['tfolio'] == '' || ($tdatidvisitaAccion['tfolio'] <> '' && $midestacion31['folio'] <> ''))
                            {
                            echo('<button class="btn btn-warning" type="button" id="anterior" name="anterior"> << Anterior</button>');
                            echo '&nbsp';           
                            echo('<button class="btn btn-warning" type="button" id="guardar" disabled="" name="guardar">---- Guardar ----</button>');
                            }
                            else
                            {
                            echo('<button class="btn btn-warning" type="button" id="anterior" name="anterior"> << Anterior</button>');
                            echo '&nbsp';           
                            echo('<button class="btn btn-warning" type="button" id="guardar" name="guardar">---- Guardar ----</button>');    
                            }
                            ?>   
...
function paso1(opcion)
    ...
    insertidpaso();
    mensajedesinco();
    location.href = "../perfilproductivo/c_actualizarpp/fc_actualizarpp?folio="+ <?php echo($folio); ?> + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val() + "&idestacion=31";
    //location.href = "../perfilproductivo/c_ppactualizar/fc_ppactualizar?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=31";               
...
function paso5(opcion)
    {
    location.href = "../historiahogar/c_validacioneerf2/fc_validacioneerf2?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=31";
    }
...
//NO TOCAR funcion que generar el mensaje de guardado    
    ...
    {
    new jBox('Notice', {
        content: 'Tu warningrmacion se Guardado!!!',
        color: 'red',
    ...
    {
    new jBox('Notice', {
        content: 'Tu warningrmacion se Actualizo!!!',
        color: 'red',
        animation: {open: 'tada', close: 'flip'},
        position: {x: 'right', y: 'center'},
        autoClose: 2000

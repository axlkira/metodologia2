...
// inicio cap 1    
    function c1p1(folio)
    { 
//        location.href = "../c_c1p1ap12LCV1/fc_c1p1ap12LCV1?folio="+ folio +"&idintegrante=0";
    }
// fin cap 1
// inicio cap 2 
    function c2p1(folio)
    { 
        location.href = "../c_c2p1intermediaLCV1/fc_c2p1intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c2p2(folio)
    { 
        location.href = "../c_c2p2intermediaLCV1/fc_c2p2intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c2p3(folio)
    { 
        location.href = "../c_c2p5intermediaLCV1/fc_c2p5intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c2p4(folio)
    { 
        location.href = "../c_c2p7intermediaLCV1/fc_c2p7intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c2p5(folio)
    { 
        location.href = "../c_c2p8intermediaLCV1/fc_c2p8intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c2p6(folio)
    { 
        location.href = "../c_c2p9intermediaLCV1/fc_c2p9intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c2p7(folio)
    { 
        location.href = "../c_c2p11intermediaLCV1/fc_c2p11intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
...
// inicio cap 6
    function c6p1(folio)
    { 
        location.href = "../c_c6p10intermediaLCV1/fc_c6p10intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c6p2(folio)
    { 
        location.href = "../c_c6p11intermediaLCV1/fc_c6p11intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c6p3(folio)
    { 
        location.href = "../c_c6p12intermediaLCV1/fc_c6p12intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c6p4(folio)
    { 
        location.href = "../c_c6p13intermediaLCV1/fc_c6p13intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c6p5(folio)
    { 
       location.href = "../c_c6p14intermediaLCV1/fc_c6p14intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
    function c6p6(folio)
    { 
        location.href = "../c_c6p15intermediaLCV1/fc_c6p15intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
...
// inicio cap 11
    ...
    { 
        location.href = "../c_c11p11intermediaLCV1/fc_c11p11intermediaLCV1?folio="+ folio +"&idintegrante=0";
    }
...
//                                            });
                ...
                {        $.ajax({
                         url: "fc_cerrarform",
                          type: "GET",
                         data: {vfolio: $('#folio').val(), vidpaso: 9004, vestado:1},
                         dataType: "html",
                          success : function(obj){                      
                          botonactualizar();
                          }

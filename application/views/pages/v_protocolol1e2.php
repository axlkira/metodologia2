...
<!--fin para imprimir el folio y llevarlo-->
                ...
                <form class="form-group" class="form-group col-md-offset-1" name="formulario" id="formulario">
                    ...
                    <h1 class="panel-title"><span class="badge">Estación 2</span></h1>
                    </div>
                    <div class="panel-body  text-justify">
                      El Levantamiento del perfil productivo de los integrantes económicamente activos del hogar, obtiene información específica respecto a la experiencia laboral, nivel educativo,  emprendimiento,  e intereses particulares que permitirán focalizar la gestión y acercamiento de oportunidades de formación, empleo, intermediación laboral y emprendimiento 
                    </div>
                    </div>
                    </div>
...
<!-- /////////////////////////////////////////////////////////////////// fin nuevo ////////////////////////////////////// -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking" id="modpaso1" <?php if ($midpaso['maximoidpaso']<='1109' && $tdatidvisita['tfolio']<>''){}else{echo 'disabled';}?>>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso1('1201');" name=cerrar1 id=cerrar1 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking2" id="modpaso2" <?php if($midpaso['maximoidpaso']=='1201') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso2('1202');" name=cerrar2 id=cerrar2 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking3" id="modpaso3" <?php if($midpaso['maximoidpaso']=='1202') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 3</span> ------ Estrategias de Autonomía ------</p>
                            </button>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <h5 class="modal- text-justify" id="myModalLabel"><br><br>
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso3('1203');" name=cerrar3 id=cerrar3 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking4" id="modpaso4" <?php if($midpaso['maximoidpaso']=='1203') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 4</span> ------ Construyendo nuestro perfil productivo ------</p>
                            </button>
                        </div>
                    </div>
                    </div>
                    <!--inicio modal-->
                            <div class="modal fade" id="modalAddTracking4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3>Construyendo nuestro perfil productivo (hoja de vida de cada integrante)</h3>    
                                        </div>
                                        <div class="modal-body">
                                            <!--<input type="text" class="form-control input-sm" id="valoridpaso" name="valoridpaso"  style="display:none" placeholder="Text input" value="">-->
                                        <h5 class="modal- text-justify" id="myModalLabel">Permite conocer las competencias personales empresariales o laborales asociadas con la experiencia, el interés en la gestión de búsqueda de empleos, el emprendimiento
                                            y los procesos formativos de la población participante del proyecto<br><br> Las respuestas deben ser suministradas por cada uno de los integrantes del hogar mayores de 15 años. En caso de que alguno de los integrantes
                                            del hogar no se encuentre en la vivienda, el Gestor Territorial de Familia levantará la información a través de la llamada telefónica. <br>
                                            Es necesaria que sea recolectada la totalidad de la información de las personas económicamente activas del hogar, de esto depende el acercamiento adecuado de oportunidades laborales. <br><br> 
                                            <br><br>
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso4('1204');" name=cerrar4 id=cerrar4 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6 text-left" type="button" data-toggle="modal" data-target="#modalAddTracking5" id="modpaso5" <?php if($midpaso['maximoidpaso']=='1204') {echo ('enabled');} else {echo ('disabled');}?>>
...
La información de las oportunidades debe quedar registrada en la historia del hogar, de tal manera que al llegar a la Línea Plan de vida familiar pueda hacerse el registro en el sistema de información (DTR).
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso5('1205');" name=cerrar5 id=cerrar5 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking6" id="modpaso6" <?php if($midpaso['maximoidpaso']=='1205') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso6('1206');" name=cerrar6 id=cerrar6 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking7" id="modpaso7" <?php if($midpaso['maximoidpaso']=='1206') {echo ('enabled');} else {echo ('disabled');}?>>
                               <p class="text-left"><span class="badge">Paso 7</span> ------  Actualizar ficha del hogar ------</p>
                            </button>
                        </div>
                    </div>
                    </div>
                    ...
                    <!--inicio modal paso anterior-->
                            <div class="modal fade" id="modalAddTracking7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3>Actualizar ficha del hogar</h3>    
                                        </div>
                                        <div class="modal-body">
                                        <h5 class="modal- text-justify" id="myModalLabel">Momento para  registrar los aspectos y avances más significativos del hogar durante el proceso de acompañamiento,  en torno a privaciones, dimensiones del desarrollo humano,  mejoramiento de relaciones familiares y elementos asociados a su corresponsabilidad.
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso7('1207');" name=cerrar7 id=cerrar7 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking8" id="modpaso8" <?php if($midpaso['maximoidpaso']=='1207') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 8</span> ---- Cierre de la visita  ----</p>
                            </button>
                        </div>
                    </div>
                    </div>
                    ...
                    <div class="modal fade" id="modalAddTracking8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso8('1208');" name=cerrar8 id=cerrar8 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                        </div>
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                           ...
                           <?php if($midpaso['maximoidpaso']<'1208')
                            {
                            ...
                            else if($midpaso['maximoidpaso']='1208')
                            {
                            echo('<button class="btn btn-primary" type="button" id="anterior" name="anterior"> << Anterior</button>');
                            echo '&nbsp';           
...
function paso3(opcion)
    {
                        $.ajax({
                          url: "fc_insertarfoliocapacidades",
                          type: "GET",
                          ...
                          //$('#datos').html(obj);
                          location.href = "../capacidades/c_capap11/fc_capap11?folio="+ <?php echo($folio); ?> +"&idintegrante=0";               
                        }
                       });
...
function paso2(opcion)
    ...
    insertidpaso();
    mensajedesinco();
    location.href = "../perfilproductivo/c_actualizarpp/fc_actualizarpp?folio="+ <?php echo($folio); ?> + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val() + "&idestacion=12";
 //   location.href = "../perfilproductivo/c_ppactualizar/fc_ppactualizar?folio="+ <?php echo($folio); ?> + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val() + "&idestacion=12";               
    }  

function paso4(opcion)
    {
     location.href = "../perfilproductivo/c_ppc1p1n5/fc_ppc1p1n5?folio="+ <?php echo($folio); ?> + "&idintegrante=0";      
...
function paso5(opcion)
    {
        ...
        location.href = "../c_acercaroportunidad/fc_acercaroportunidad?folio="+ <?php echo($folio); ?> +"&idintegrante="+ <?php echo($tdatinte['tidintegrante']); ?>+"&variable=3";
...
function paso6(opcion)
    ...
    {
     location.href = "../historiahogar/c_historiahogar2/fc_historiahogar2?folio="+ <?php echo($folio); ?> +"&idintegrante="+<?php echo($tdatinte['tidintegrante']); ?>+"&doccogestor="+ $('#doccogestor').val() + "&idestacion=12";  
    }
    ...
    $(document).ready(function()
    {
        ...
        //funcion que controla el cierre de los pasos de la estación
              $("#guardar").click(function ()
                ...
                {
                   // alert('juapis');
                location.href = "../c_principalprotocolo/fc_principalprotocolo?folio="+ <?php echo($folio); ?> +"&idintegrante="+<?php echo($tdatinte['tidintegrante']); ?>+"&doccogestor="+ $('#doccogestor').val();                  
                });
               ...
               //NO TOCAR - voler a capitulos                
                ...
                {
                   // alert('juapis');
                location.href = "../c_capituloshogar/fc_capituloshogar?folio="+ <?php echo($folio); ?> +"&idintegrante="+<?php echo($tdatinte['tidintegrante']); ?>;                  
                });

                ...
                <div class="row">
                    <div class="form-group form-group-sm">   
                        <div class="form-group  ">
                           ...
                           <div class="panel-heading">Cualidades por integrante del hogar</div>
                           <div class="panel-body">
                             <p>Por favor clic para iniciar las cualidades por integrante</p>
                           </div>
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                         ...
                         &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                           ...
                           <?php
                          ?> &nbsp; <?php
                          echo('<button class="btn btn-warning col-md-offset-6" type="button" id="cerrar" name="cerrar"><< Cerrar Cualidades personales >></button>');
                          }
                          else{
                          echo('<button class="btn btn-primary col-sm-offset-0" type="button" id="volver" name="volver"><< Volver</button>');?> &nbsp;
                              &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      //    echo('<button class="btn btn-primary col-sm-offset-0" type="button" id="volverintegrante" name="volverintegrante"><< Editar Integrante</button>');?> &nbsp; <?php
                          echo('<button class="btn btn-warning col-md-offset-6" type="button" disabled="" id="cerrar" name="cerrar"><< Cerrar Cualidades personales >></button>');
                          }
                          ?>
                          </div>
...
///////////////////////////////////////Funciones para opcion multiple o unica////////////////////////////////////////////////////////////////////////    
    ...
    { 
                          ...
                          $.ajax({
                          url: "fc_llenarcapitulosintegrantel2e1",
                          type: "GET",
                          data: {vfolio : folio,
                          ...
                          //botonguardar();
                          location.href = "../c_c1l2e1chintegrante/fc_c1l2e1chintegrante?folio="+ folio +"&idintegrante=" + idinte;
                                                    }
                          });
                ...
                $("#cerrar").click(function ()
                {
                    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: 2107, vestado:1},
                          dataType: "html",
                          success: function(obj) {
...
//                   }
                ...
                location.href = "../c_c1l2e1ch/fc_c1l2e1ch?folio="+ $('#folio').val() +"&idintegrante=0"+"&doccogestor="+$('#doccogestor').val();;
                });

...
<hr>
  ...
  <div class="form-group  has-feedback">
    ...
    <input type="text" class="form-control input-sm" id="valorcualidad1" name="valorcualidad1"  value="<?php echo($arrayrespuestas['ecualidad1']); ?>" disabled="disabled">
    <span class="glyphicon glyphicon-ok form-control-feedback" aria-hidden="true"></span>
  </div>
  
   <div class="form-group  has-feedback">
    <label class="control-label" for="valorc11p12b">Segunda cualidad seleccionada</label>
    <input type="text" class="form-control input-sm" id="valorcualidad2" name="valorcualidad2"  value="<?php echo($arrayrespuestas['ecualidad2']); ?>" disabled="disabled">
    <span class="glyphicon glyphicon-ok form-control-feedback" aria-hidden="true"></span>
  </div>

    <div class="form-group  has-feedback">
    <label class="control-label" for="valorc11p12c">Tercera cualidad seleccionada</label>
    <input type="text" class="form-control input-sm" id="valorcualidad3" name="valorcualidad3"  value="<?php echo($arrayrespuestas['ecualidad3']); ?>" disabled="disabled">
    <span class="glyphicon glyphicon-ok form-control-feedback" aria-hidden="true"></span>
  </div>
                
  <div class="form-group  has-feedback">
    <label class="control-label" for="valorc11p12d">Cuarta cualidad seleccionada</label>
    <input type="text" class="form-control input-sm" id="valorcualidad4" name="valorcualidad4"  value="<?php echo($arrayrespuestas['ecualidad4']); ?>" disabled="disabled">
    <span class="glyphicon glyphicon-ok form-control-feedback" aria-hidden="true"></span>
  </div>
                

            <div id="c11p12bdiv" name="c11p12bdiv" <?php if($arrayrespuestas['ecualidad1']==''){echo('class="form-group col-md-12 form-group-sm has-error"');}else{echo('class="form-group col-md-12 form-group-sm"');}?>>   
                <label class="control-label">Identificacion de las cualidades Familiares
            ...
            <?php if($arrayrespuestas['ecualidad1']=="")
            {
                echo($botoneragcapa);
            }
            else
...
<script> 
    ...
    {//alert('JP');
                        ...
                        $.ajax({
                          ...
                          type: "GET",
                          data: {vfolio : $('#folio').val(),vcualidad : $('#valorfiltro').val(),
...
/* Podemos usar un selector cualquiera siempre que tenga checkboxes… y podéis limitarlo a lo que queráis */
        ...
        $("#guardar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),vvalorcualidad1: $('#valorcualidad1').val(), vvalorcualidad2 : $('#valorcualidad2').val(),vvalorcualidad3 : $('#valorcualidad3').val(),vvalorcualidad4 : $('#valorcualidad4').val()},    
                          dataType: "html",
                          success : function(obj){                      
                          botonguardar();
                          }
...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','Pregunta 1','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['etitular']); ?>','100');

...
<body>  
    <div class="container">
        ...
        <input type="text" class="form-control input-sm" id="idestacion" name="idestacion" style="display:none" value="<?php echo $idestacion ?>">
    ...
    <div class="panel-heading" role="tab" id="headingOne">
      <h4 class="panel-title">
        <a role="button" data-toggle="collapse" data-parent="#accordion" href="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
          <h5>¿Cómo está Conformado el hogar?<small> (En este campo se describe cómo está conformado el hogar: por madre, padre e hijos, amigos, parientes lejanos, etc.)</small></h5>
        </a>

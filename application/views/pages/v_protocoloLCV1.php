...
<!-- /////////////////////////////////////////////////////////////////// fin nuevo ////////////////////////////////////// -->
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso1('9001');" name=cerrar1 id=cerrar1 class="btn btn-info" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-info col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking2" id="modpaso2" <?php if(($midpaso['maximoidpaso'] == '9001')) {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso2('9002');" name=cerrar2 id=cerrar2 class="btn btn-info" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-info col-md-6 text-left" type="button" data-toggle="modal" data-target="#modalAddTracking4" id="modpaso4" <?php if(($midpaso['maximoidpaso'] == '9002')){echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso4('9003');" name=cerrar4 id=cerrar4 class="btn btn-info" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-info col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking3" id="modpaso3" <?php if(($midpaso['maximoidpaso'] == '9003')){echo ('enabled');} else {echo ('disabled');}?>>
...
<!--                                        onclick="paso3('5003');"-->
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso3('9004');insertarfoliohintermedia()" name="cerrar3" id="cerrar3"  class="btn btn-info" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-info col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking6" id="modpaso6" <?php if(($midpaso['maximoidpaso'] == '9004')){echo ('enabled');} else {echo ('disabled');}?>>
...
<br><br>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso6('9005');" name=cerrar6 id=cerrar6 class="btn btn-info" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-info col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking9" id="modpaso9" <?php if(($midpaso['maximoidpaso'] == '9005')){echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking9" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso9('9006');" name="cerrar9" id="cerrar9" class="btn btn-info" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                            ...
                            <?php if($midpaso81['emaximoidpaso81']<'9006')
                            {
...
function paso4(opcion)
    {
//        alert('nuevo');
location.href = "../c_totalintegrantesintermediaLCV1/fc_totalintegrantesintermediaLCV1?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&variable=90";
    }
...
function paso5(opcion)
  ...
  function paso6(opcion)
    {
     location.href = "../c_acercaroportunidad/fc_acercaroportunidad?folio="+ $('#folio').val() + "&idintegrante="+ <?php echo($tdatinte['tidintegrante']); ?> +"&doccogestor=" + $('#doccogestor').val()+ "&variable=90";  

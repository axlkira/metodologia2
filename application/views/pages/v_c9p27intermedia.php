    ...
    if(campoval == 'c9p27intermediao1')
        {
            if($('#' + campoval).val() == 'SI')
            {
                ...
                $('#c9p27intermediao1cuantomostrar').show(1000);
            ...
            {
                //alert('aca lo oculta');
                $('#c9p27intermediao1cuantomostrar').hide(1000);
        ...
        if(campoval == 'c9p27intermediao2')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p27intermediao2cuantomostrar').show(1000);
            ...
            {
                //alert('aca lo oculta');
                $('#c9p27intermediao2cuantomostrar').hide(1000);
        ...
        if(campoval == 'c9p27intermediao3')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p27intermediao3cuantomostrar').show(1000);
            ...
            {
                //alert('aca lo oculta');
                $('#c9p27intermediao3cuantomostrar').hide(1000);

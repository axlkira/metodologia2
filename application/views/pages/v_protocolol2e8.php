...
<!--fin para imprimir el folio y llevarlo-->
                ...
                <form class="form-group" class="form-group col-md-offset-1" name="formulario" id="formulario">
                    ...
                    <h1 class="panel-title"><span class="badge">Estación 8</span></h1>
                    </div>
...
<!-- /////////////////////////////////////////////////////////////////// fin nuevo ////////////////////////////////////// -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking" id="modpaso1" <?php if ($midpaso['maximoidpaso']=='2706' && $tdatidvisita['tfolio'] <> ''){}else{echo 'disabled';}?>>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h5 class="modal- text-justify" id="myModalLabel">El Gestor Territorial de Familia saluda a los integrantes del hogar, se presenta en caso de cambio de profesional y/o recuerda su nombre y profesión. Indaga por lo trabajado en la visita anterior y los compromisos pendientes por cumplir. Así mismo, realiza la trazabilidad del proceso de acompañamiento familiar.</h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso1('2801');" name=cerrar1 id=cerrar1 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking2" id="modpaso2" <?php if($midpaso['maximoidpaso']=='2801') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <h5 class="modal- text-justify" id="myModalLabel"> Se realiza la actualización de datos de contacto de ubicación, como son dirección, número telefónico, barrio y comuna, al igual que los estados de los integrantes del grupo familiar.
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso2('2802');" name=cerrar2 id=cerrar2 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking3" id="modpaso3" <?php if($midpaso['maximoidpaso']=='2802') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 3</span> ------ Seguimiento Plan de vida Familiar: ------</p>
                            </button>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking3" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3>                                           
                                            Seguimiento Plan de vida Familiar:
                                            </h3>    
                                        </div>
                                        <div class="modal-body">
                                        ...
                                        <h5 class="modal- text-justify" id="myModalLabel">El Gestor Territorial de Familia, realiza seguimiento y evaluación del diagnóstico actual de la familia al momento de realizar la visita, en el que permita observar las dimensiones del desarrollo humano que se encuentran pendientes por movilizar (color rojo), de tal manera que permita el correcto acercamiento de oportunidades que movilicen el cumplimiento del 77% de los logros para cumplir la condición necesaria.<br><br>
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso3('2803');" name=cerrar3 id=cerrar3 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking4" id="modpaso4" <?php if($midpaso['maximoidpaso']=='2803') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 4</span> ---- Validación de logros ---</p>
                            </button>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h3>                                          
                                            Validación de logros en las dimensiones del desarrollo:
                                            </h3>    
                                        </div>
                                        <div class="modal-body">
                                        <h5 class="modal- text-justify" id="myModalLabel">Para desarrollar este apartado, se requiere que el Gestor Territorial de Familia se remita al diagnóstico actual del hogar, en que le permita ubicarse en las dimensiones que se encuentran en el semáforo de color rojo, es decir, que tienen pendiente la movilización de los logros, de tal manera que la intención de esta visita de acompañamiento familiar, permita la movilización de los logros pendientes para que se pueda cumplir la condición necesaria.<br><br>
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso4('2804');" name=cerrar4 id=cerrar4 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking5" id="modpaso5" <?php if($midpaso['maximoidpaso']=='2804') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking5" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso5('2805');" name=cerrar5 id=cerrar5 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6 text-left" type="button" data-toggle="modal" data-target="#modalAddTracking6" id="modpaso6" <?php if($midpaso['maximoidpaso']=='2805') {echo ('enabled');} else {echo ('disabled');}?>>
                                <p class="text-left"><span class="badge">Paso 6</span> ------ Actualización Ficha del hogar: ------</p>
                            </button>
                        </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <h5 class="modal- text-justify" id="myModalLabel">Se requiere que el profesional psicosocial, responsable del desarrollo de la visita realizada, actualice en el sistema de información la ficha del hogar, alimentándola con las novedades presentadas del sistema familiar.</h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso6('2806');" name=cerrar6 id=cerrar6 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking7" id="modpaso7" <?php if($midpaso['maximoidpaso']=='2806') {echo ('enabled');} else {echo ('disabled');}?>>
                               <p class="text-left"><span class="badge">Paso 7</span> ------ Evaluación y cierre: ------</p>
                            </button>
                           </div>
                    </div>
                    </div>
                            ...
                            <div class="modal fade" id="modalAddTracking7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                       <div class="panel-body  text-justify">Para finalizar la visita de acompañamiento familiar, el Gestor Territorial de Familia indaga por la evaluación cualitativa de la visita realizada, despejará dudas e inquietudes que se puedan presentar y procederá al diligenciamiento de la planilla de efectividad.</div>
                                                 </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso7('2807');" name="cerrar7" id="cerrar7" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
...
<!-- ////////////////////////////////////////////////// nuevo informativo////////////////////////////////////////////-->
 ...
 <!--<div class="row">
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-warning col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking0Accion" id="modpaso0Accion" <?php if ($midpaso['maximoidpaso'] < '2807' || $tdatidvisitaAccion['tfolio'] <> ''){echo 'disabled';}else {echo 'enabled';}?>>
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                           ...
                           <?php if($midpaso['maximoidpaso'] <> '2807')
                            {
...
function paso1(opcion)
    {
    iniciocoordenadas(28); // inserta la informacion en la tabla t_protocoloinicioestacion    
    //alert(opcion);
    ...
    insertidpaso();
    mensajedesinco();
    location.href = "../perfilproductivo/c_actualizarpp/fc_actualizarpp?folio="+ <?php echo($folio); ?> + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val() + "&idestacion=28";
    //location.href = "../perfilproductivo/c_actualizarpp/fc_actualizarpp?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=28";               
    }

    function paso4(opcion)
    {
        $('#modalsinco').modal('show');
     location.href = "../logros/c_dimensiones/fc_dimensiones?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=28";     
    }
    
function paso5(opcion)
 {
    location.href = "../c_acercaroportunidad/fc_acercaroportunidad?folio="+ $('#folio').val() + "&idintegrante="+ <?php echo($tdatinte['tidintegrante']); ?> +"&doccogestor=" + $('#doccogestor').val()+ "&variable=11";     
 }
    
function paso6(opcion)
    {
    location.href = "../historiahogar/c_historiahogar2/fc_historiahogar2?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=28";    
    }

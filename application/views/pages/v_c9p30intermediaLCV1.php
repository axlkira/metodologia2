...
<hr>
        <form class="form-group" name="formulario" id="formulario">
            ...
            <div class="row">
            <div id="c9p30intermediadiv" name="c9p30intermediadiv" <?php if($arrayrespuestas['ec9p30intermedia']==''){echo('class="form-group col-md-12 form-group-sm has-error"');}else{echo('class="form-group col-md-12 form-group-sm"');}?>>   
                ...
                <div class="radio">
                    <label><!--en este caso se manda a la fincion javascript el valor del campo-->
                        <input type="radio" name="c9p30intermedia" id="c9p30intermedia" onclick="colocaropcion('1','valorc9p30intermedia','c9p30intermediadiv');" value="1" <?php if($arrayrespuestas['ec9p30intermedia']=='1'){echo('checked');}?>>
                        Si
                    </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" name="c9p30intermedia" id="c9p30intermedia" onclick="colocaropcion('2','valorc9p30intermedia','c9p30intermediadiv');" value="2" <?php if($arrayrespuestas['ec9p30intermedia']=='2'){echo('checked');}?>>
                        No
                    </label>             
                </div> 
                <input type="text" class="form-control" id="valorc9p30intermedia" name="valorc9p30intermedia" style="display:none" placeholder="Text input" value="<?php echo($arrayrespuestas['ec9p30intermedia']); ?>">
            </div>
            </div> 
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
        ...
        Por favor no cierre este dialogo... hasta que salga el mensaje de finalizacion.
            ...
            <?php if($arrayrespuestas['ec9p30intermedia']=="")
           {
                echo($botoneraginter);
            }
            else
    ...
    $(document).ready(function()
    {
        ...
        {mensajedesinco();
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),vidintegrante : $('#idintegrante').val(), vvalorc9p30intermedia : $('#valorc9p30intermedia').val()},    
                          dataType: "html",
                          success : function(obj){                      
                         
                          saltarc9p30intermedia();
                          }
                        });                    
        });
        ...
        $("#siguiente").click(function ()
        {
         ...
         {
             location.href = "../c_c9p31intermediaLCV1/fc_c9p31intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                     
         }
...
function saltarc9p30intermedia()
{
if($('#valorc9p30intermedia').val() === '2')
         {                
                          $.ajax({
                          url: "../c_c9p31intermediaLCV1/fc_actualizar",
                          type: "GET",
                          ...
                          $.ajax({
                          url: "../c_c9p32intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val()
                              ,vidintegrante : $('#idintegrante').val()
                         ...
                         $.ajax({
                          url: "../c_c9p33intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val()
                              ,vidintegrante : $('#idintegrante').val()
                          ...
                          success : function(obj)
                          {
                            ...
                            $.ajax({
                          url: "../c_c9p34intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val()
                              ,vidintegrante : $('#idintegrante').val()
                          ...
                          $.ajax({
                          url: "../c_c9p35intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),
                          vidintegrante : $('#idintegrante').val(),
                          ...
                          $.ajax({
                          url: "../c_c9p36intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),
                          vidintegrante : $('#idintegrante').val(),

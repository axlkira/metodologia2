...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','16 de 16','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','100');
    ...
    if(opcion == '1')
        {
           // alert('aca lo muestra');
            $('#c9p23intermediacuantodivmostrar').show();
        ...
        {
            //alert('aca lo oculta');
            $('#c9p23intermediacuantodivmostrar').hide();

...
<body>  
    <div class="container">
        ...
        <input type="text" class="form-control input-sm" id="idestacion" name="idestacion"  style="display:none"   placeholder="idestacion" value="<?php echo($idestacion); ?>">
...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
    function insertidpaso(opcion)
   {
    //alert('test');
                        ...
                        //location.href = "../../c_protocolol3sc/fc_protocolol3sc?folio="+ $('#folio').val() +"&idintegrante=0";
                         }
                       });
   }
    ...
    $(document).ready(function()
    {
        ...
        $("#siguiente").click(function ()
        {
         ...
         {
          insertidpaso(9106);   
          location.href = "../../c_protocolocierreadmin/fc_protocolocierreadmin?folio=" + $('#folio').val()+"&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=31";  
         } 
         else
         {
          insertidpaso(2308);     

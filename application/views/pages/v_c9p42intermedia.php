...
//         
         ...
         {
           location.href = "../c_c9p43intermedia/fc_c9p43intermedia?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";    
         }
    ...
    if(campoval == 'c9p42intermediao4')
        {
            if($('#' + campoval).val() == 'SI')
            {
                ...
                $('#c9p42intermediacualmostrar').show(1000);
            ...
            {
                //alert('aca lo oculta');
                $('#c9p42intermediacualmostrar').hide(1000);

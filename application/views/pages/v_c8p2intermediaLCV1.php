...
//    alert(div + ' juanpis ' + campo);
   ...
   validarguardarc8p2intermedia();
    ...
    $(document).ready(function()
    {
        ...
        {
         botonsiguiente();
        if($('#valorc8p2intermedia').val() == 'c8p2intermediao1' || $('#valorc8p2intermedia').val() == 'c8p2intermediao14' ||
         $('#valorc8p2intermedia').val() == 'c8p2intermediao2' || $('#valorc8p2intermedia').val() == 'c8p2intermediao3' || 
         $('#valorc8p2intermedia').val() === 'c8p2intermediao4' || 
           $('#valorc8p2intermedia').val() == 'c8p2intermediao6' || $('#valorc8p2intermedia').val() == 'c8p2intermediao8' ||
            $('#valorc8p2intermedia').val() == 'c8p2intermediao10' || $('#valorc8p2intermedia').val() == 'c8p2intermediao12')
           {                $.ajax({
                            url: "../c_c8p3intermediaLCV1/fc_actualizar",
                            type: "GET",
                            data: {vfolio : $('#folio').val(),
                            vidintegrante : $('#idintegrante').val(),
                            vc8p3intermedia : '98'},
        ...
        $("#anterior").click(function ()
        {
            ...
            {
                 botonanterior();
         location.href = "../c_c8p1intermediaLCV1/fc_c8p1intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"&variable=81";                    
            }
...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','2 de 4','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','50');

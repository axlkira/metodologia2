...
//esta funcion nos permite guardar el valor de una opcion de seleccion multiple
    ...
    { 
        if($('#variable').val()=='81')
        {
            location.href = "../c_integrantesintermedia/fc_integrantesintermedia?folio="+ folio +"&idintegrante="+idinte + "&variable=81";
        }
        else
        {
...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
    $(document).ready(function()
    {
                 ...
                 $("#nintegrante").click(function ()
                {
                   // alert('juapis');
                banderainsertar = '1';  
                location.href = "../c_integrantesintermedia/fc_integrantesintermedia?folio="+ $('#folio').val() +"&idintegrante="+"&idintegrante=0"+"&bandera="+banderainsertar + "&variable=81";              
                });

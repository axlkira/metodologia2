    ...
    if(campoval == 'c9p29intermediao1')
        {
            if($('#' + campoval).val() == 'SI')
            {
                ...
                $('#c9p29intermediao1cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p29intermediao1cuantomostrar').hide();
        ...
        if(campoval == 'c9p29intermediao2')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p29intermediao2cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p29intermediao2cuantomostrar').hide();
        ...
        if(campoval == 'c9p29intermediao3')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p29intermediao3cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p29intermediao3cuantomostrar').hide();
       ...
       if(campoval == 'c9p29intermediao4')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p29intermediao4cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p29intermediao4cuantomostrar').hide();

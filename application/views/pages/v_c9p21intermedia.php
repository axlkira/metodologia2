...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','Pregunta 14 de 16','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','80');
...
//                         $.ajax({
//                          url: "../c_c9p22intermedia/fc_actualizar",
//                          type: "GET",
...
//        }
//        
//         else if (($('#valorc9p21intermedia').val() === '1' && $('#c9p22').val() === '98'))
//         {               
//                          $.ajax({
//                          url: "../c_c9p22intermedia/fc_actualizar",
//                          type: "GET",

                    ...
                    <div class="form-group form-group-sm">   
                        <div class="form-group  ">
                           ...
                           <div class="panel-body">
                             <p>Por favor clic para iniciar el formulario por integrante para realizar la visita Intermedia de Cierre</p>
                           </div>
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                          ...
                          echo('<button class="btn btn-primary col-sm-offset-0" type="button"  id="volver" name="volver"><< Volver >></button>');?> &nbsp; <?php
                          ...
                          echo('<button class="btn btn-primary col-sm-offset-0" style="display:none" type="button" id="volver" name="volver"><< Volver a Capitulos Hogar</button>');?> &nbsp; <?php
                          echo('<button class="btn btn-primary col-sm-offset-0" type="button" id="volverintegrante" name="volverintegrante"><< Editar Integrante</button>');?> &nbsp; <?php
...
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
          ...
          <div class="modal fade" id="modalintegrante" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-body">
          <input type="text" class="form-control" style="display:none" id="foliodiligenciainte" name="foliodiligenciainte"  value="">
          <input type="text" class="form-control" style="display:none" id="ideintediligenciainte" name="ideintediligenciainte"  value="">
          <p class="col-lg-offset-3"><h3>Presione continuar , para realizar el formulario.</h3></p>
      </div>
      <div class="modal-footer">
          <button type="button" id="continuarintegrante" class="btn btn-primary">Continuar</button>
...
$('#modal1207').modal();
  ...
  function modalintegrante(folio,idintegrante) 
{

$('#modalintegrante').modal();
$('#foliodiligenciainte').val(folio);
$('#ideintediligenciainte').val(idintegrante);
 insertarcapintegrantesintermedia(folio,idintegrante);
...
function insertarcapintegrantesintermedia(folio,idintegrante)
{
    ...
    $.ajax({
                          ...
                          success : function(obj){    
                                   ...
                                   // location.href = "../c_capitulosintegranteintermedia/fc_capitulosintegranteintermedia?folio="+ folio +"&idintegrante=" + idintegrante;      
...
//        
           ...
           $("#continuarintegrante").click(function ()
                {
                  location.href = "../c_capitulosintegranteintermediaLCV1/fc_capitulosintegranteintermediaLCV1?folio="+ $('#foliodiligenciainte').val() +"&idintegrante=" + $('#ideintediligenciainte').val();      
       ...
       //
                ...
                //fin de la funcion actualizar foliodiligenciainte
                ...
                $("#cerrar").click(function ()
                {
                    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: 9003, vestado:1},
                          dataType: "html",
                          success: function(obj) {
                ...
                {
                // alert('juapis');
                location.href = "../c_totalintegrantesintermediaLCV1/fc_totalintegrantesintermediaLCV1?folio="+ $('#folio').val() +"&idintegrante=0" + "&variable=90";                  
                });

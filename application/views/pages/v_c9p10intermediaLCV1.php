...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','3 de 12 subcapitolo 9M','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','24');
    ...
    if(opcion == '1')
        {
           // alert('aca lo muestra');
            $('#c9p10intermediacuantodivmostrar').show();
        ...
        {
            //alert('aca lo oculta');
            $('#c9p10intermediacuantodivmostrar').hide();

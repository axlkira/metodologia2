...
function saltarc9p14intermedia()
{
    ...
    $(document).ready(function()
    {
        ...
        {
          location.href = "../c_c9p19intermedia/fc_c9p19intermedia?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                    
        ...
        {
         botonanterior();
         location.href = "../c_c9p13intermedia/fc_c9p13intermedia?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                    
        });
...
function cambiarsinoc9p14intermedia(opcion,campoval,divcampo,divcompleto,campos)
{
    ...
    if(campoval == 'c9p14intermediao1' || campoval == 'c9p14intermediao2' || campoval == 'c9p14intermediao3' )
            {  
                ...
                $('#c9p14intermediacuantomostrar').show(1000);
            ...
            {
                //alert('aca lo oculta');
                $('#c9p14intermediacuantomostrar').hide(1000);

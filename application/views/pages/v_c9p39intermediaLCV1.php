...
//                         $('#c9p39intermediao8').val('SI');
        ...
        {
         botonanterior();
         location.href = "../c_c9p38intermediaLCV1/fc_c9p38intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val() +"";                    
...
function saltarc9p39intermedia()
{
    if ($('#c9p37o11').val()=== 'SI'  && $('#c9p38o9').val()=== 'SI'  && $('#c9p39intermediao7').val()=== 'SI')
    {
                         ...
                         $.ajax({
                          url: "../c_c9p40intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {
                              vfolio : $('#folio').val()
                         ...
                         $.ajax({
                          url: "../c_c9p41intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {
                              vfolio : $('#folio').val()
                              ,vidintegrante : $('#idintegrante').val()
                        ...
                        $.ajax({
                          url: "../c_c9p42intermediaLCV1/fc_actualizar",
                          type: "GET",
                          data: {
                              vfolio : $('#folio').val()
                              ,vidintegrante : $('#idintegrante').val()

...
<hr>
        <form class="form-group" name="formulario" id="formulario">
            ...
            <div id="ppactualizodiv" name="ppactualizodiv" <?php if($arrayrespuestas['eactualizo']==''){echo('class="form-group col-md-12 form-group-sm has-error"');}else{echo('class="form-group col-md-12 form-group-sm"');}?>>   
                <label class="control-label"> Desea actualizar la informacion del hogar y de los integrantes?
...
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
        ...
        <div class="modal fade" id="modal8102" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-footer">
          <button type="button" id="continuar8102" class="btn btn-primary">Continuar</button>
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
      </div>
    </div>
  </div>
...
//          location.href = "../../c_protocolol1e2/fc_protocolol1e2?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val();
            ...
            { 
             ...
             if($('#idestacion').val() === '81'){ 
                if($('#valorppactualizo').val() === '1' || $('#valorppactualizo').val() === '3' )
                {
                 location.href = "../c_actualizarpp/fc_actualizarpp?folio=" + $('#folio').val()+"&idintegrante=0"+"&idestacion=81";
                 //location.href = "../actualizarpp/c_actualizarpp/fc_actualizarpp?folio=" + $('#folio').val()+"&idintegrante=0";

                }
                else // aqui cuando es no, opcion 2
                {      
              //alert('ww');
              insertidpaso(8102); 
              Modal8102();
 ...
 $("#anterior").click(function ()
        {
           ...
           if($('#idestacion').val() === '12')
               ...
               {
                    location.href = "../../c_protocolol1e1/fc_protocolol1e1?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+"&idestacion=11";
               }
               ...
               {
                    location.href = "../../c_protocolol2e6/fc_protocolol2e6?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+"&idestacion=25";
               }
               else if($('#idestacion').val() === '81')
               {
                    location.href = "../../c_protocolointermedia/fc_protocolointermedia?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+"&idestacion=81";
               }
               else 
               {

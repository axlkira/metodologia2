...
<div class="row">
        ...
        <div  id="edaddiv" name="edaddiv" class="form-group col-md-2 form-group-sm">
         ...
         <input type="text" class="form-control input-sm" id="telefono" onblur="validarcantdigitosfijo('telefono','telefonodiv')" name="telefono" onkeypress="return soloNumeros(event)" maxlength="10" placeholder="ingrese número telefónico"   value="<?php  echo($foexiste['etelefono']); ?>">
         </div>
         ...
         <input type="text" class="form-control input-sm" id="celular" onblur="validarcantdigitos('celular',10,'celulardiv')" name="celular" onkeypress="return soloNumeros(event)" maxlength="10" placeholder="ingrese celular" value="<?php  echo($foexiste['ecelular']); ?>">
         </div>
...
//                });
                ...
                location.href = "../c_actualizarintpp/fc_actualizarintpp?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=" + $('#idestacion').val(); 
                });
...
validarBloquePP($('#idestacion').val(),$('#edad').val())
</script>
</html>
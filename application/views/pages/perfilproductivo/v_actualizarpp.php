...
<html lang="es">
    ...
    <body>  
        <div class="container">
            ...
            <input type="text" class="form-control input-sm" id="actualizo" name="actualizo" style="display: none" placeholder="Text input" value="<?php echo($actexiste['eactualizo']); ?>">
            ...
            <ul class="nav nav-tabs">
                ...
                <li role="presentation"><a href="../c_actualizarintpp/fc_actualizarintpp?folio=<?php echo($folio);?>&idintegrante=0&doccogestor=<?php echo($foexiste['edoccogestor']); ?>&idestacion=<?php echo($idestacion); ?>">Actualizar información general integrantes del hogar</a></li>
            </ul>
            </div><br>
            ...
            <form class="form-group col-md-12 col-md-offset-1" name="formulario" id="formulario"><br>
                <!--incio de campos de texto-->
                    ...
                    <div class="form-group col-md-2 form-group-sm">
                        ...
                        <input type="text" class="form-control input-sm" id="folio" name="folio" OnFocus="this.blur()" placeholder="Text input" value="<?php echo($foexiste['efolio']); ?>">
                    </div>
<!--                    <div class="form-group col-md-1 form-group-sm">
                        <label for="estado">Estado</label>
                        <input type="text" class="form-control input-sm" id="estado" name="estado" OnFocus="this.blur()" placeholder="Text input" value="<?php echo($foexiste['eestadof']); ?>">
                    </div>    -->
...
<!--                    <div class="form-group col-md-5 form-group-sm">
                        ...
                        <select class="form-control input-sm" id="rephogar" name="rephogar" onchange="validarbolitasytexto('c1p3div','c1p3');">
                    ...
                    <div class="form-group col-md-3 form-group-sm">
                        ...
                        <select class="form-control input-sm" id="motivo" name="motivo" onchange="validarbolitasytexto('c1p3div','motivo');">
...
<!--opcion de seleccion-->
                    ...
                    <div id="c1p3div" name="c1p3div" <?php if($foexiste['eestrato']==''){echo('class="form-group col-md-4 form-group-sm has-error"');}else{echo('class="form-group col-md-4 form-group-sm"');}?>>   
                    ...
                    <div id="c1p4div" name="c1p4div" <?php if($foexiste['ecomuna']==''){echo('class="form-group col-md-4 form-group-sm has-error"');}else{echo('class="form-group col-md-4 form-group-sm"');}?>>   
...
<!--opcion de seleccion-->
<!--                    <label for="c1p6">Dirección de la vivienda</label>
                    <div class="row">
                    <div class="form-group col-md-2 form-group-sm">    
                    ...
                    <select class="form-control input-sm" id="c1p6a" name="c1p6a" onchange="llenarotrocampo();">
                            ...
                            <option value="TR">Transveral</option>
                    </select> 
                    </div>
                            <div class="form-group col-md-1 form-group-sm">
                            <label> </label>
...
incio de campo de texto
                    <div class="row">
                    <div id="c1p6div" name="c1p6div" <?php if($foexiste['edireccion']=='' || $foexiste['edireccion']=='   #  - INT  | ' ){echo('class="form-group col-md-10 form-group-sm has-error"');}else{echo('class="form-group col-md-10 form-group-sm"');}?>>   
...
<label for="c1p6">6 Dirección de la vivienda</label>
                    <div class="row">
                            <div id="divc1p6a"<?php if($foexiste['edireccion']==''){echo('class="form-group col-md-2 form-group-sm has-error"');}else{echo('class="form-group col-md-2 form-group-sm"');}?>>                        <select class="form-control input-sm" id="c1p6a" name="c1p6a" onchange="validardireccion('divc1p6a','c1p6a');">
                            <option value="">Seleccione una opción</option>    
                            <option value="CL">Calle</option>
                            <option value="CR">Carrera</option>
                            <option value="AV">Avenida</option>
...
<!--incio de campos de texto-->
                    ...
                    <div id="c1p7div" name="c1p7div" <?php if($foexiste['etelefono']==''){echo('class="form-group col-md-2 form-group-sm has-error"');}else{echo('class="form-group col-md-2 form-group-sm"');}?>>   
                        ...
                        <input type="text" class="form-control input-sm" id="telefono" name="telefono" onKeyPress="return soloNumeros(event)" onblur="validarcantdigitosfijo('telefono','c1p7div')" placeholder="Text input" maxlength="10" value="<?php echo($foexiste['etelefono']); ?>">
                    </div>
                    <div id="c1p8div" name="c1p8div" <?php if($foexiste['ecelular']==''){echo('class="form-group col-md-2 form-group-sm has-error"');}else{echo('class="form-group col-md-2 form-group-sm"');}?>>   
                        ...
                        <input type="text" class="form-control input-sm" id="celular" name="celular" onKeyPress="return soloNumeros(event)" onblur="validarcantdigitos('celular',10,'c1p8div')" placeholder="Text input" maxlength="10" value="<?php echo($foexiste['ecelular']); ?>">
                    </div>    
...
<!--incio de campos de texto-->
                    ...
                    <!--<div id="c1p9div" name="c1p9div" <?php if($foexiste['ec1p9']==''){echo('class="form-group col-md-5 form-group-sm has-error"');}else{echo('class="form-group col-md-5 form-group-sm"');}?>>   
                        <label class="control-label" for="c1p9">Nombre de un contacto</label>
                    ...
                    <div id="c1p10div" name="c1p10div" <?php if($foexiste['ec1p10']==''){echo('class="form-group col-md-3 form-group-sm has-error"');}else{echo('class="form-group col-md-3 form-group-sm"');}?>>   
                        <label class="control-label" for="c1p10">Parentesco o relación del contacto</label>
...
<!--incio de campo de texto-->
                    ...
                    <!--<div id="c1p12div" name="c1p12div" <?php if($foexiste['ec1p12']==''){echo('class="form-group col-md-5 form-group-sm has-error"');}else{echo('class="form-group col-md-5 form-group-sm"');}?>>   
                        <label class="control-label" for="c1p12">Persona responsable que brinda la información</label>
...
{ 
   if(($('#'+ campo).val() == '') || ($('#'+ campo).val() == '0') || ($('#'+ campo).val() == '   #  - INT  | ') ) 
  { 
...
//                          url: "fc_insertar",
//                          type: "GET",
//                          data: {vestrato: $('#estrato').val(), vcomuna: $('#comuna').val(), vbarrio: $('#barrio').val(), vdireccion: $('#c1p6').val(), vtelefono: $('#telefono').val(),vcelular: $('#celular').val(),vtelfcont: $('#telfcont').val(),vcelcont: $('#celcont').val()},
//                          dataType: "html",
//                          success : function(obj){                      
...
//                });
                ...
                $("#actualizar").click(function ()
                {
                   // alert('juapis');
                        $.ajax({
                          url: "fc_actualizarh",
                          type: "GET",
                          data: {vfolio : $('#folio').val(), vestrato: $('#estrato').val(), vcomuna: $('#comuna').val(), vbarrio: $('#barrio').val(), vdireccion: $('#c1p6').val(), vtelefono: $('#telefono').val(),vcelular: $('#celular').val(),vtelfcont: $('#telfcont').val(),vcelcont: $('#celcont').val()},
                          dataType: "html",
                          success : function(obj){                      
                ...
                $("#anterior").click(function ()
                {
                  ...
                  {
                  location.href = "../../c_protocolol1e2/fc_protocolol1e2?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val() + "&idestacion="+$('#idestacion').val(); 
                  }
                  else
                    {
                      if($('#idestacion').val() === '21')
                        {
                        location.href = "../../c_protocolol2e1/fc_protocolol2e1?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                        }
                      if($('#idestacion').val() === '22')
                        {
                        location.href = "../../c_protocolol2e2/fc_protocolol2e2?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                        } 
                      if($('#idestacion').val() === '23')
                        {
                        location.href = "../../c_protocolol2e3/fc_protocolol2e3?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                        }
                      if($('#idestacion').val() === '24')
                        {
                        location.href = "../../c_protocolol2e4/fc_protocolol2e4?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                        } 
                      if($('#idestacion').val() === '25')
                        {
                        location.href = "../../c_protocolol2e5/fc_protocolol2e5?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                        } 
                      if($('#idestacion').val() === '26')
                        {
                        location.href = "../../c_protocolol2e6/fc_protocolol2e6?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                        }
                      if($('#idestacion').val() === '27')
                       {
                       //insertidpaso27(); 
                       location.href = "../../c_protocolol2e7/fc_protocolol2e7?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();    
                       }
                      if($('#idestacion').val() === '28')
                       {
                       //insertidpaso28(); 
                       location.href = "../../c_protocolol2e8/fc_protocolol2e8?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();    
                       }
                      if($('#idestacion').val() === '81')
                       {
                       location.href = "../../c_protocolointermedia/fc_protocolointermedia?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                       }
                      if($('#idestacion').val() === '31')
                       {
                      location.href = "../../c_protocolol3sc/fc_protocolol3sc?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                       }  
                      if($('#idestacion').val() === '90')
                       {
                       //insertidpaso90(); 
                       location.href = "../../c_protocoloLCV1/fc_protocoloLCV1?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();    
                       }
                      if($('#idestacion').val() === '91')
                       {
                       //insertidpaso91();  
                       location.href = "../../c_protocolocierreadmin/fc_protocolocierreadmin?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();   
                       }
                 ...
                 //   {
                //  insertidpaso11(); 
                  location.href = "../../c_protocolol1e1/fc_protocolol1e1?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
                  
                 //   }
                 //   else
                 //   {      
                //    location.href = "../c_ppactualizar/fc_ppactualizar?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val(); 
    ...
    function insertidpaso()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '1202', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso1()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2102', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso2()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2202', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso11()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '1103', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   /*
   function insertidpaso25()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2502', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso26()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2602', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso27()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2702', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          location.href = "../../c_protocolol2e7/fc_protocolol2e7?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();   
                        }
   ...
   function insertidpaso28()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2802', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          location.href = "../../c_protocolol2e8/fc_protocolol2e8?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();   
                        }
   ...
   function insertidpaso90()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '9002', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          location.href = "../../c_protocoloLCV1/fc_protocoloLCV1?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();   
                        }
   ...
   function insertidpaso91()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '9102', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          location.href = "../../c_protocolocierreadmin/fc_protocolocierreadmin?folio="+ $('#folio').val() +"&idintegrante=0" + "&doccogestor="+$('#doccogestor').val()+ "&idestacion="+$('#idestacion').val();   
                        }
...
*/
   ...
   function insertidpaso31()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '3102', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
  ...
  /* function insertidpaso23()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2302', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso81()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '8102', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
   ...
   function insertidpaso102()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '102', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);
...
/*
   function insertidpaso24()
   {
    //alert('test');
                        $.ajax({
                          url: "fc_cerrarpaso1",
                          type: "GET",
                          data: {vfolio: $('#folio').val(), vidpaso: '2402', vestado:1},
                          dataType: "html",
                          success: function(obj) {
                          //me llama el mensajito de actualizar
                          //$('#datos').html(obj);

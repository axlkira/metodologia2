...
<hr>
        <form class="form-group" name="formulario" id="formulario">
            ...
            <div class="row">
            <div id="c9p21div" name="c9p21div" <?php if($arrayrespuestas['ec9p21']==''){echo('class="form-group col-md-12 form-group-sm has-error"');}else{echo('class="form-group col-md-12 form-group-sm"');}?>>   
                ...
                <div class="radio">
                    <label><!--en este caso se manda a la fincion javascript el valor del campo-->
                        <input type="radio" name="c9p21" id="c9p21" onclick="colocaropcion('1','valorc9p21','c9p21div');" value="1" <?php if($arrayrespuestas['ec9p21']=='1'){echo('checked');}?>>
                        Si
                    </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" name="c9p21" id="c9p21" onclick="colocaropcion('2','valorc9p21','c9p21div');" value="2" <?php if($arrayrespuestas['ec9p21']=='2'){echo('checked');}?>>
                        No
                    </label>             
                </div> 
                <input type="text" class="form-control" id="valorc9p21" name="valorc9p21" style="display:none" placeholder="Text input" value="<?php echo($arrayrespuestas['ec9p21']); ?>">
            </div>
            </div> 
    ...
    $(document).ready(function()
    {
        ...
        $("#guardar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),vidintegrante : $('#idintegrante').val(), vvalorc9p21 : $('#valorc9p21').val()},    
                          dataType: "html",
...
function saltop()
{
    if($('#valorc9p21').val() === '2')
         ...
         else if (($('#valorc9p21').val() === '1' && $('#c9p22').val() === '98'))
         {               
                          $.ajax({
                          url: "../c_c9p22/fc_actualizar",
                          type: "GET",

...
<?php // echo($arrayrespuestasid['eidintegrantetitularid']); ?>
...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
 ...
 $("#sincoportunidad").click(function ()
        ...
        $("#oportunidadh").click(function ()
        {
         ...
         if ($('#evariable').val()== '1')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=1" ;                    
           }
           else  if ($('#evariable').val()== '2')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=2" ;                    
           }else  if ($('#evariable').val()== '4')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=4" ;                    
           }
           else  if ($('#evariable').val()== '5')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=5" ;                    
           }
            else  if ($('#evariable').val()== '6')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=6" ;                    
           }
           else  if ($('#evariable').val()== '7')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=7" ;                    
           }
           else  if ($('#evariable').val()== '8')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=8" ;                    
           }
           else  if ($('#evariable').val()== '9')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=9" ;                    
           }
           else  if ($('#evariable').val()== '10')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=10" ;                    
           }
           else  if ($('#evariable').val()== '11')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=11" ;                    
           }
           else  if ($('#evariable').val()== '81')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=81" ;                    
           }
           else  if ($('#evariable').val()== '90')
            {          
             location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=90" ;                    
            }
            else  if ($('#evariable').val()== '91')
            {          
             location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=91" ;                    
            }
           else  if ($('#evariable').val()== '102')
           {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=102" ;                    
           }
           
           else
               {          
         location.href = "../c_acercaroportunidadh/fc_acercaroportunidadh?folio=" + $('#folio').val() +  "&idintegrante=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> + "&variable=3" ;                    
           }
        });
...
//para la edad
          ...
          if($('#evariable').val()=='1')
          {
             location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=1" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='2')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=2" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }else if ($('#evariable').val()=='4')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=4" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }else if ($('#evariable').val()=='5')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=5" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='6')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=6" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='7')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=7" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='8')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=8" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='9')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=9" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='10')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=10" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='11')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=11" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='81')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=81" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='90')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=90" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='91')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=91" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
          else if ($('#evariable').val()=='102')
          {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=102" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }
              
                   
          else 
           {
              location.href = "../c_acercaroportunidadi/fc_acercaroportunidadi?folio="+ folio +"&idintegrante="+idintegrante+  "&idtitular=" + <?php echo($arrayrespuestasid['eidintegrantetitularid']); ?> +"&variable=3" + "&yea=" + yea + "&mes=" + mes + "&dias=" + dias;            
          }   
//fin para la edad

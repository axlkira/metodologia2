...
<!--fin para imprimir el folio y llevarlo-->
            ...
            <ul class="nav nav-tabs">
                <li role="presentation" ><a href="../c_actualizar/fc_actualizar?folio=<?php echo($folio);?>&idintegrante=0">Actualizar información general del hogar</a></li>
...
///////////////////////////////////////Funciones para opcion multiple o unica////////////////////////////////////////////////////////////////////////    
    ...
    { 
        location.href = "../c_aintegrantes/fc_aintegrantes?folio="+ folio +"&idintegrante="+idinte+"&doccogestor="+ $('#doccogestor').val(); 
    }

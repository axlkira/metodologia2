...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','2 de 12 Subcapitulo 9M','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','17');
    ...
    if(opcion == 'c9p8intermediao9')
        {
           // alert('aca lo muestra');
            $('#c9p8intermediacualmostrar').show();
        ...
        {
            //alert('aca lo oculta');
            $('#c9p8intermediacualmostrar').hide();

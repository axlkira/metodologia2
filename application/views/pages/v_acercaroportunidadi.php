...
<!--        <input type="text" class="form-control input-sm" id="edad" name="edad"    placeholder="" value="">
        <input type="text" class="form-control input-sm" id="nmeses" name="nmeses"     placeholder="" value="">
        <input type="text" class="form-control input-sm" id="ndias" name="ndias"      placeholder="" value="">-->
        <input type="text" class="form-control input-sm" id="sexo" name="sexo" style="display:none"     placeholder="" value="<?php echo($arraydatosgenerales['esexointegrante']); ?>">
        <input type="text" class="form-control input-sm" id="fnacimiento" name="fnacimiento"   style="display:none"     placeholder="" value="<?php echo($arraydatosgenerales['efechanacimiento']); ?>">
                          ...
                          <div class="panel panel-info">
                           ...
                           <div class="panel-body">
                             ...
                             <div class="form-group">
                                 ...
                                 <div class="col-sm-2">
                                     <input type="text"  class="form-control input-sm text-uppercase" id="idbuscopi" onkeypress="return soloNumeros(event)" placeholder="Digite el id" >
                                </div>
                                 
                                 <div class="col-sm-2">
                                     <input type="text"  class="form-control input-sm text-uppercase" id="nombuscopi"  placeholder="Digite Oportunidad" onkeypress="" placeholder="Nombre integrante " >
                                </div>
                  ...
                  <select class="form-control input-sm  " id="dimension" name="dimension"  >
                     ...
                     <option value="">Seleccione Dimension</option>
                      ...
                      <option value="7">DINAMICA FAMILIAR</option>
                                       ...
                                       <div>   
                                       <button class="btn btn-danger col-sm-offset-0" type="button" id="buscar"  onclick="filtrartablai();" name="buscar"> Buscar </button>
...
//                          vvaloracercaroportunidadi : $('#valoracercaroportunidadi').val()},    
//                          dataType: "html",
...
//                          data: {vfolio : $('#folio').val(),
//                          vidintegrante : $('#idintegrante').val(),
//                          vsel1 : $('#valoracercaroportunidadi').val()},    
//                          dataType: "html",
//                          success : function(obj){                      
//                          botonguardar();
//                          }
...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','oportunidad','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "." Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   Años: ".$edadyear." Meses: ".$edadmeses); ?>','0');
...
function botongi(a){
    ...
    if ($('#idoportunidad' + a).val() == ''){
        ...
        $('#acercari' + a).prop('disabled',true);
    }else{

        $('#acercari' + a).prop('disabled',false);
    }
...
function totalizar()
{
                   $.ajax({
                    ...
                    data: {vidintegrante :$('#idintegrante').val(),
                           yea : <?php echo ($edadyear); ?>,
                           mes : <?php echo ($edadmeses); ?>},    
                    dataType: "html",
                    success : function(obj){  
                    $('#tothogar').html(obj);
               ...
               function filtrartablai()
               {
                   mensajedesinco();
                  $.ajax({
                                          url: "fc_filtrartablai",
                                          type: "GET",
                                          data: {vidintegrante : $('#idintegrante').val(),
                                                 vidbuscopi : $('#idbuscopi').val(),
                                                 vnombuscopi : $('#nombuscopi').val(),
               ...
               function otraopormejora(idoportunidadno,versionn,valor)
                ...
                function guardaroportunidadi(idoportunidad,version)
                {
                 ...
                 function eliminaroportunidadi(idoportunidad)
                {

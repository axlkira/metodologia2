...
<?php
$porcentaje_total = floatval($foexisteporcen['eporceverd']) + floatval($foexisteporcen['eporcegris']);
?>
<h6>Porcentaje total de logros (verdes + grises): <small><?php echo $porcentaje_total; ?> %</small></h6>
...
<!--fin para imprimir el folio y llevarlo-->
                ...
                <form class="form-group" class="form-group col-md-offset-1" name="formulario" id="formulario">
                    ...
                    <div class="panel-body  text-justify">
                      Estación para el seguimiento al plan de vida familiar, orientación y planteamiento de nuevas acciones, revisión de dificultades y avances del hogar.

Revisión de los logros  definidos en el proyecto  no relacionados con las metas iniciales,  pero que tienen incidencia en el mejoramiento de condiciones de vida y dinámica familiar del hogar.
...
<!-- /////////////////////////////////////////////////////////////////// fin nuevo ////////////////////////////////////// -->
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking" id="modpaso1" <?php if ($midpaso['maximoidpaso']=='2109' && $tdatidvisita['tfolio'] <> ''){}else{echo 'disabled';}?>>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            ...
                                            <h5 class="modal- text-justify" id="myModalLabel">El Gestor Territorial de Familia saluda de manera cordial y cálida al hogar, indicando que la visita se enfocará en los sueños que tiene el hogar y cada uno de sus integrantes. Adicional se procede a explicar la duración aproximada de la visita</h5>    
                                        </div>
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso1('2201');" name=cerrar1 id=cerrar1 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking2" id="modpaso2" <?php if($midpaso['maximoidpaso']=='2201') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking2" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso2('2202');" name=cerrar2 id=cerrar2 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking3" id="modpaso3" <?php if($midpaso['maximoidpaso']=='2202') {echo ('enabled');} else {echo ('disabled');}?>>
...
Una vez revisado el plan de vida familiar inicial, se Introduce al hogar en el análisis de otros logros pendientes que no necesariamente pueden estar relacionados con sus metas específicas pero que influyen en el mejoramiento de su calidad de vida. 
 <br><br>
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso3('2203');" name=cerrar3 id=cerrar3 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking4" id="modpaso4" <?php if($midpaso['maximoidpaso']=='2203') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking4" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso4('2204');" name=cerrar4 id=cerrar4 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6 text-left" type="button" data-toggle="modal" data-target="#modalAddTracking5" id="modpaso5" <?php if($midpaso['maximoidpaso']=='2204') {echo ('enabled');} else {echo ('disabled');}?>>
...
La información de las oportunidades debe quedar registrada en la historia del hogar, de tal manera que al llegar a la Línea Plan de vida familiar pueda hacerse el registro en el sistema de información (DTR).
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso5('2205');" name=cerrar5 id=cerrar5 class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
...
<!--                    <div class="row">
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking6" id="modpaso6" <?php if($midpaso['maximoidpaso']=='2205') {echo ('enabled');} else {echo ('disabled');}?>>
...
<!--                            <div class="modal fade" id="modalAddTracking6" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking7" id="modpaso7" <?php if($midpaso['maximoidpaso']=='2206') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                        <h5 class="modal- text-justify" id="myModalLabel">
                                            Momento para  registrar los aspectos y avances más significativos del hogar durante el proceso de acompañamiento,  en torno a privaciones, dimensiones del desarrollo humano,  mejoramiento de relaciones familiares y elementos asociados a su corresponsabilidad.
                                        </h5>    
                                        </div>
                                        <div class="modal-footer">
...
<!--                            <div class="modal fade" id="modalAddTracking7" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
 ...
 <br><br>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking8" id="modpaso8" <?php if($midpaso['maximoidpaso']=='2207') {echo ('enabled');} else {echo ('disabled');}?>>
                            ...
                            <div class="modal fade" id="modalAddTracking8" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            <button type="button"  onclick="paso8('2208');" name="cerrar8" id="cerrar8" class="btn btn-danger" data-dismiss="modal">Cerrar</button>
                                        </div>
                                    </div>
                                </div>
                            </div><br>                    
...
<!-- ////////////////////////////////////////////////// nuevo informativo////////////////////////////////////////////-->
 ...
 <!--<div class="row">
                    <div class="form-group">
                        <div class="col-sm-offset-1 col-sm-10">
                            <button  class="btn btn-success col-md-6" type="button" data-toggle="modal" data-target="#modalAddTracking0Accion" id="modpaso0Accion" <?php if ($midpaso['maximoidpaso'] < '2208' || $tdatidvisitaAccion['tfolio'] <> ''){echo 'disabled';}else {echo 'enabled';}?>>
...
<!--inicio botonera guardar y actualizar NO SE TOCA-->
                           ...
                           <?php if($midpaso['maximoidpaso'] <> '2208')
                            {
...
function paso1(opcion)
    ...
    insertidpaso();
    mensajedesinco1();
    location.href = "../perfilproductivo/c_actualizarpp/fc_actualizarpp?folio="+ <?php echo($folio); ?> + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val() + "&idestacion=22";
    //location.href = "../perfilproductivo/c_ppactualizar/fc_ppactualizar?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=22";               

    } 
function paso3(opcion)
    {
   
location.href = "../linea2estacion1/c_metahogar/fc_metahogar?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=22";       
    }

function paso4(opcion)
 {
    $('#modalsinco').modal('show');
    location.href = "../logros/c_dimensiones/fc_dimensiones?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=22"; 
//    $('#valoridpaso').val(opcion);
//    insertidpaso();
...
function paso5(opcion)
    {
    //alert(opcion);
    location.href = "../c_acercaroportunidad/fc_acercaroportunidad?folio="+ $('#folio').val() + "&idintegrante="+ <?php echo($tdatinte['tidintegrante']); ?> +"&doccogestor=" + $('#doccogestor').val()+ "&variable=5";  
    }
...
//    }
    ...
    {
    location.href = "../historiahogar/c_historiahogar2/fc_historiahogar2?folio="+ $('#folio').val() + "&idintegrante=0"+ "&doccogestor=" + $('#doccogestor').val()+ "&idestacion=22";
//    
...
//     location.href = "../casoexitoso/c_casoexitoso/fc_casoexitoso?folio="+ $('#folio').val() +"&idintegrante="+$('#idintegrante').val()+"&doccogestor="+$('#doccogestor').val()+"&idestacion=22";  
    ...
    //$('#modpaso0Accion').prop('disabled', false); onclick="paso8('2208');"

...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','6 de 12 subcapitulo 9M','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','38');
...
function cambiarsinoc9p13intermedia(opcion,campoval,divcampo,divcompleto,campos)
{
    ...
    if(campoval == 'c9p13intermediao1' || campoval == 'c9p13intermediao2')
            {  
                ...
                $('#c9p13intermediacuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p13intermediacuantomostrar').hide();

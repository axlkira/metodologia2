...
<html lang="es">
    ...
    <div class="container" id="acordeon">
            ...
            <!-- fin head            -->
            <h3>Vista de las dimensiones e información de los logros</h3>
            ...
            <table class="table table-bordered" colspan="6">
                        ...
                        <table class="table table-bordered" colspan="6">
                            ...
                            <tbody>
                                <tr>
                                    <td colspan="1" align="left">7. Las personas entre 18 a 65 años que lo requieren acceden a empleo.</td>
...
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
    ...
    <div class="modal fade" id="modal2404" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-footer">
          <button type="button" id="continuar2404" class="btn btn-primary">Continuar</button>
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
      </div>
    </div>
  </div>
    ...
    <div class="modal fade" id="modal2504" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-footer">
          <button type="button" id="continuar2504" class="btn btn-primary">Continuar</button>
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
      </div>
    </div>
  </div>
    ...
    <div class="modal fade" id="modal2604" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-footer">
          <button type="button" id="continuar2604" class="btn btn-primary">Continuar</button>
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modal2703" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-footer">
          <button type="button" id="continuar2703" class="btn btn-primary">Continuar</button>
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
      </div>
    </div>
  </div>
...
<div class="modal fade" id="modal2804" data-backdrop="static" >
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        <h5 class="modal-title"></h5>
...
<!--          <span aria-hidden="true">&times;</span>-->
      ...
      <div class="modal-footer">
          <button type="button" id="continuar2804" class="btn btn-primary">Continuar</button>
<!--        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>-->
      </div>
    </div>
  </div>
 ...
 $("#continuar2").click(function (){
        ...
        $("#continuar2703").click(function (){
            
           
            location.href = "../../c_protocolol2e7/fc_protocolol2e7?folio="+ $('#folio').val() +"&idintegrante=0"+"&doccogestor="+$('#doccogestor').val()+"&idestacion=27";
            
        });

        $("#continuar2804").click(function (){
            
           
            location.href = "../../c_protocolol2e8/fc_protocolol2e8?folio="+ $('#folio').val() +"&idintegrante=0"+"&doccogestor="+$('#doccogestor').val()+"&idestacion=28";

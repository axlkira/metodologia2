...
cargardatosgenerales('<?php echo($arraydatosgenerales['ecapitulo']); ?>','8 de 12','<?php echo($arraydatosgenerales['enomcoges']); ?>','<?php echo($arraydatosgenerales['enombreintegrante']." "." - "." "."Sexo:"." ".$arraydatosgenerales['esexointegrante']."   "."  -  "."   "."Edad:"."   ".$arraydatosgenerales['eedadintegrante']); ?>','64');
    ...
    if(opcion == '1')
        {
           // alert('aca lo muestra');
            $('#c9p16intermediacuantodivmostrar').show();
        ...
        {
            //alert('aca lo oculta');
            $('#c9p16intermediacuantodivmostrar').hide();

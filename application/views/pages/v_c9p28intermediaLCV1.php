...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
    $(document).ready(function()
    {
        ...
        $("#siguiente").click(function ()
        {
         ...
         location.href = "../c_c9p29intermediaLCV1/fc_c9p29intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val();                    
    ...
    if(campoval == 'c9p28intermediao1')
        {
            if($('#' + campoval).val() == 'SI')
            {
                ...
                $('#c9p28intermediao1cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p28intermediao1cuantomostrar').hide();
        ...
        if(campoval == 'c9p28intermediao2')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p28intermediao2cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p28intermediao2cuantomostrar').hide();
        ...
        if(campoval == 'c9p28intermediao3')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p28intermediao3cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p28intermediao3cuantomostrar').hide();
       ...
       if(campoval == 'c9p28intermediao4')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p28intermediao4cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p28intermediao4cuantomostrar').hide();
       ...
       if(campoval == 'c9p28intermediao5')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p28intermediao5cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p28intermediao5cuantomostrar').hide();
       ...
       if(campoval == 'c9p28intermediao6')
        {
            ...
            {
                //alert('aca lo muestra');
                $('#c9p28intermediao6cuantomostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p28intermediao6cuantomostrar').hide();

    ...
    <div class="container">
        ...
        <div class="row">
            <div class="col-md-10">
                ...
                <p class="text-right"><small>Te encuentras en el capitulo <strong>4. CARACTERISTICAS GENERALES (Integrantes) </strong> línea 1 estación 1</small></p><br>
        ...
        <input type="text" class="form-control input-sm" id="idintegrante" name="idintegrante" style="display: none" placeholder="Text input" value="<?php echo ($idintegrante); ?>">
        ...
        <input type="text" class="form-control input-sm" id="clasificacionhogar" style="display: none" name="clasificacionhogar" value="<?php echo ($tdatintemenores['tclasificacionHogar']); ?>">
        <input type="text" class="form-control input-sm" id="haymenores" style="display: none" name="haymenores" value="<?php echo ($tdatintemenores['tHayMenores']); ?>">
        <input type="text" class="form-control input-sm" id="totalmenores" style="display: none" name="totalmenores" value="<?php echo ($tdatintemenores['ttotalmenores']); ?>">
        <input type="text" class="form-control input-sm" id="totalintegrantes" style="display: none" name="totalintegrantes" value="<?php echo ($tdatintemenores['ttotalintegrantes']); ?>">
        <input type="text" class="form-control input-sm" id="totalmayores" style="display: none" name="totalmayores" value="<?php echo ($tdatintemenores['ttotalmayores']); ?>">
        ...
        <form class="form-group" name="formulario" id="formulario">
            <!--opcion de seleccion-->
            <div class="row">
                <div id="tdocumentoodiv" name="tdocumentoodiv" <?php if ($foexiste['etipodocumento'] == '') {
                ...
                <div class="form-group col-md-4 form-group-sm" id="nacionalidaddiv" name="nacionalidaddiv" <?php if ($foexiste['enacionalidad'] == '') {
                ...
                <div id="ndocumentodiv" name="ndocumentodiv" <?php if ($foexiste['etipodocumento'] == 'No tiene') {
                echo ('class="form-group col-md-4 form-group-sm" style="display: none"');
                } else if ($foexiste['edocumento'] == '') {
                echo ('class="form-group col-md-4 form-group-sm has-error"');
                } else if ($foexiste['edocumento'] == '98') {
                echo ('class="form-group col-md-4 form-group-sm" style="display: none"');
                } {
                echo ('class="form-group col-md-4 form-group-sm"');
                } ?>>
            ...
            <div class="row">
                <div id="pnombrediv" name="pnombrediv" <?php if ($foexiste['enombre1'] == '') {
                echo ('class="form-group col-md-3 form-group-sm has-error"');
                } else {
                echo ('class="form-group col-md-3 form-group-sm"');
                } ?>>
                ...
                <div id="papellidodiv" name="papellidodiv" <?php if ($foexiste['eapellido1'] == '') {
                echo ('class="form-group col-md-3 form-group-sm has-error"');
                } else {
                echo ('class="form-group col-md-3 form-group-sm"');
                } ?>>
            ...
            <div class="row">
                <div id="fnacimientodiv" name="fnacimientodiv" <?php if ($foexiste['efnacimiento'] == '') {
                echo ('class="form-group col-md-2 form-group-sm has-error "');
                } else {
                echo ('class="form-group col-md-2 form-group-sm"');
                } ?>>

                    <label class="control-label">Fecha de Nacimiento</label>
                    <input type="date" class="form-control input-sm" id="fnacimiento" onchange="enviarnumjp()" name="fnacimiento" onblur="calcularfecha(this.value)" value="<?php echo ($foexiste['efnacimiento']); ?>" <?php if ($banderainsertar == '1')
                     {
                     echo ('');
                     } else {
                     echo ('disabled=""');
                ...
                <div id="sexodiv" name="sexodiv" <?php if ($foexiste['esexo'] == '') {
                    echo ('class="form-group col-md-2 form-group-sm has-error"');
                    } else {
                    echo ('class="form-group col-md-2 form-group-sm"');
                    } ?>>
                    <label class="control-label" for="sexo">Sexo</label>
                    <select class="form-control input-sm" id="sexo" onchange="enviarnumjp('sexodiv','sexo')" name="sexo" <?php if ($banderainsertar == '1')
                        {
                        echo ('');
                        } else {
                        echo ('disabled=""');
                ...
                <div id="telefonodiv" name="telefonodiv" <?php if ($foexiste['etelefono'] == '') {
                echo ('class="form-group col-md-2 form-group-sm has-error"');
                } else {
                echo ('class="form-group col-md-2 form-group-sm"');
                } ?>>
                ...
                <div id="celulardiv" name="celulardiv" <?php if ($foexiste['ecelular'] == '') {
                echo ('class="form-group col-md-2 form-group-sm has-error"');
                } else {
                echo ('class="form-group col-md-2 form-group-sm"');
                } ?>>
...
<!-- fin nuevas variables -->            
            <div id="acutualizardiv" <?php if ($variable == '81') {
            echo 'style="display:none"';
            } else {
            echo '';
            }  ?>>
            <button class="btn btn-success" type="button" id="actualizarfs" name="actualizarfs" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" data-target="#myModal" <?php if ($banderainsertar == '1') {
            echo ('disabled=""');
            } else {
            echo ('');
            } ?>>Editar fecha de nacimiento(Edad) y Sexo </button>
            </div>
            <hr> <br><br>
            ...
            <?php if ($idintegrante <> 0) //NO SE TOCA bonotes si es nuevo folio
            {
                if ($idintegrante <> $dtitular['tidintegrantetitular']) {
                    ...
                    echo ('<button class="btn btn-primary"  type="button" id="actualizar" disabled=""  name="actualizar">Actualizar</button>&nbsp'); //NO SE TOCA bonotes si es para actualizar folio
                    echo ('<button class="btn btn-primary " type="button" id="cancelar" name="cancelar">Volver</button>');
                    echo ('<button class="btn btn-primary  col-sm-offset-7"  type="button" id="eliminar" name="eliminar" style=display:none>Eliminar</button>');
                }
            } else {
    ...
    <script src="<?php echo BOOTSTRAP, 'js/sweetalert2@11.js' ?>"></script>
...
<script>
    ...
    function soloLetras(e) {
        ...
        if ((key >= 65 && key <= 90) || (key == 8) || (key == 32)) {} else {
    ...
    $(document).ready(function() {
        ...
        $("#guardar").click(function() {
            //alert($('#edad').val()); alert($('#clasificacionhogar').val());alert($('#haymenores').val());alert($('#totalmenores').val());alert($('#totalintegrantes').val());alert($('#totalmayores').val());
          if (($('#clasificacionhogar').val() == 'c1p13o1') && ($('#haymenores').val() == '2') && ($('#edad').val() < 18)) {
                Swal.fire({
                    icon: 'error',
                    title: '<h4>Usted en el Capitulo 6 pregunta 9m18 selecciono:</h4><br><h6>No hay menores de 18 años</h6>',
                    width: 600,
                    footer: '<a>Por favor actualice la información para que sea consistente</a>'
                })
            }else if (($('#clasificacionhogar').val() == 'c1p13o14') && ($('#totalintegrantes').val() >= '1')) {
                Swal.fire({
                    icon: 'error',
                    title: '<h4>Usted en el Capitulo 1 pregunta 13 selecciono:</h4><br><h6>Hogar unipersonal (Hogar conformado por un solo integrante)</h6>',
                    width: 600,
                    footer: '<a>Por favor actualice la información para que sea consistente</a>'
                })
            } else if (($('#clasificacionhogar').val() == 'c1p13o13') && ($('#edad').val() < 50)) {
                Swal.fire({
                    icon: 'error',
                    title: '<h4>Usted en el Capitulo 1 pregunta 13 selecciono:</h4><br><h6>Hogar conformado solo por persona mayor (Corresponde a los hogares en los cuales el integrante o los integrantes que lo conforman tienen 50 años o mas)</h6>',
                    width: 600,
                    footer: '<a>Por favor actualice la información para que sea consistente</a>'
                })
            } else {
            ...
            $.ajax({
                ...
                data: {
                    vfolio: $('#folio').val(),
                    vtdocumento: $('#tdocumento').val(),
                    vndocumento: $('#ndocumento').val(),
                    vpnombre: $('#pnombre').val(),
                    vsnombre: $('#snombre').val(),
                    vpapellido: $('#papellido').val(),
                    vsapellido: $('#sapellido').val(),
                    vfnacimiento: $('#fnacimiento').val(),
                    vsexo: $('#sexo').val(),
                    vedad: $('#edad').val(),
                    ...
                    vgoogle: $('#google').val(),
                    vnacionalidadv: $('#nacionalidadv').val(),
                    vetnias: $('#etnias').val(),
        ...
        $("#actualizar").click(function() {
            ...
            //}else if (($('#clasificacionhogar').val() == 'c1p13o14') && ($('#edad').val() > '17') && ($('#totalintegrantes').val() > '1')) {
                Swal.fire({
                    icon: 'error',
                    title: '<h4>Usted en el Capitulo 1 pregunta 13 selecciono:</h4><br><h6>Hogar unipersonal (Hogar conformado por un solo integrante)</h6>',
                    width: 600,
    ...
    function calcularfecha(ffeccha) {
        ...
        if ($('#fnacimiento').val() === '') {
            ...
            if ((aaaammdd[0] < 0) || (aaaammdd[0] > 110)) {
                $('#edad').val(0);
                //$('#telefono').val(0);
                //$('#celular').val(0);
                $('#fnacimiento').val('');
                boxfechanac('Fecha Invalida: No puede ser mayor a la fecha actual o tener mas de 110 años');
                $('#fnacimiento').focus();
            } else {
                $('#edad').val(aaaammdd[0]);
                if ($('#idtitular').val() == $('#idintegrante').val()) {
                    //alert($('#edad').val());
                    if ($('#edad').val() < 14) {
                        //alert($('#edad').val()+('hola'));
                        $('#edad').val('');
                        $('#fnacimiento').val('');
                        boxfechanac('La edad del titular del hogar no debe ser menor a: 14 Años');
                    }
    ...
    function calcular_edad(fecha) { //alert(fecha);

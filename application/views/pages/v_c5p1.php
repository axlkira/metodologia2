...
<hr>
        <form class="form-group" name="formulario" id="formulario">
            ...
            <div class="row">
            <div id="c5p1div" name="c5p1div" <?php if($arrayrespuestas['ec5p1']==''){echo('class="form-group col-md-12 form-group-sm has-error"');}else{echo('class="form-group col-md-12 form-group-sm"');}?>>   
                ...
                <div class="radio">
                    <label><!--en este caso se manda a la fincion javascript el valor del campo-->
                        <input type="radio" name="c5p1" id="c5p1" onclick="colocaropcion('1','valorc5p1','c5p1div');" value="1" <?php if($arrayrespuestas['ec5p1']=='1'){echo('checked');}?>>
                        Si
                    </label>
                </div>
                <div class="radio">
                    <label>
                        <input type="radio" name="c5p1" id="c5p1" onclick="colocaropcion('2','valorc5p1','c5p1div');" value="2" <?php if($arrayrespuestas['ec5p1']=='2'){echo('checked');}?>>
                        No
                    </label>             
                </div>               
                ...
                <input type="text" class="form-control" id="valorc5p1" name="valorc5p1" style="display:none" placeholder="Text input" value="<?php echo($arrayrespuestas['ec5p1']); ?>">
            </div>
            </div> 
    ...
    $(document).ready(function()
    {
        ...
        $("#guardar").click(function ()
        {
                        $.ajax({
                          url: "fc_actualizar",
                          type: "GET",
                          data: {vfolio : $('#folio').val(),vidintegrante : $('#idintegrante').val(), vvalorc5p1 : $('#valorc5p1').val()},    
                          dataType: "html",
...
//                          });
//                          }
//          else if (($('#valorc5p1').val() === '2' && $('#c5p2').val() === '98'))
//          {                $.ajax({
//                           url: "../c_c5p2/fc_actualizar",
//                           type: "GET",
//                           data: {vfolio : $('#folio').val(),

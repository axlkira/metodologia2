...
///////////////////////////////////////Funciones que llaman al controlador para guardar y actualizar////////////////////////////////////////////////////////////////////////    
    $(document).ready(function()
    {
        ...
        $("#siguiente").click(function ()
        {
         ...
         location.href = "../c_c9p36intermediaLCV1/fc_c9p36intermediaLCV1?folio=" + $('#folio').val() +  "&idintegrante=" + $('#idintegrante').val();                    
    ...
    else
    {
        ...
        if(campoval == 'c9p35intermediao7')
        {
            if($('#' + campoval).val() == 'SI')
            {
                ...
                $('#c9p35intermediao7cualmostrar').show();
            ...
            {
                //alert('aca lo oculta');
                $('#c9p35intermediao7cualmostrar').hide();

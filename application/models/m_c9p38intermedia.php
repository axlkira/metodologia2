...
class M_c9p38intermedia extends CI_Model {
    ...
    {
        $query = $this->db->query('call spbuscarcapitulo9p38intermedia('.$midintegrante.');');
        $resultado = $query->result();
        $query->next_result(); //NO SE TOCAN Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        $query->free_result(); //NO SE TOCAN  Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        return $resultado;        
    ...
    {
        $this->db->query('call spactualizarcapitulo9p38intermedia('.$mfolio.','.$midintegrante.',"'.$mvc9p38intermediao1.'","'.$mvc9p38intermediao2.'","'.$mvc9p38intermediao3.'","'.$mvc9p38intermediao4.'","'.$mvc9p38intermediao5.'","'.$mvc9p38intermediao6.'","'.$mvc9p38intermediao7.'","'.$mvc9p38intermediao8.'","'.$mvc9p38intermediao9.'","'.$mvc9p38intermediao10.'","'.$mvc9p38intermediacual.'");');
    }    

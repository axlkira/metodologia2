...
class M_diligenciarintegrante extends CI_Model {
    ...
    {        
        $query = $this->db->query('call splistartabladiligenciarintegrante('.$mfolio.');');//se llama por procedimiento l almacenado

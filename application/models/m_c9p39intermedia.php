...
class M_c9p39intermedia extends CI_Model {
    ...
    {
        $query = $this->db->query('call spbuscarcapitulo9p39intermedia('.$midintegrante.');');
        $resultado = $query->result();
        $query->next_result(); //NO SE TOCAN Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        $query->free_result(); //NO SE TOCAN  Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        return $resultado;        
    ...
    {
        $this->db->query('call spactualizarcapitulo9p39intermedia('.$mfolio.','.$midintegrante.',"'.$mvc9p39intermediao1.'","'.$mvc9p39intermediao2.'","'.$mvc9p39intermediao3.'","'.$mvc9p39intermediao4.'","'.$mvc9p39intermediao5.'","'.$mvc9p39intermediao6.'","'.$mvc9p39intermediao7.'","'.$mvc9p39intermediao8.'","'.$mvc9p39intermediacual.'");');
    }    

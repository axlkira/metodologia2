...
class M_c9p29intermediaLCV1 extends CI_Model {
    ...
    {
        $query = $this->db->query('call spbuscarcapitulo9p29intermediaLCV1('.$midintegrante.');');
        $resultado = $query->result();
        $query->next_result(); //NO SE TOCAN Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        $query->free_result(); //NO SE TOCAN  Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        return $resultado;        
    ...
    {
    $this->db->query('call spactualizarcapitulo9p29intermediaLCV1('.$mfolio.','.$midintegrante.',"'.$mc9p29o1.'","'.$mc9p29o1cuanto.'","'.$mc9p29o2.'","'.$mc9p29o2cuanto.'",

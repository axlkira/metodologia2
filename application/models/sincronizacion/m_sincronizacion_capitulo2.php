...
class M_sincronizacion_capitulo2 extends CI_Model {
    ...
    public function fm_sin_capitulo2()
    {
        $query = $this->db->query('call sp3sincronizacioncapitulo2();');//se coloca el codigo de la ayuda

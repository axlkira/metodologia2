...
class M_integrantesintermediaLCV1 extends CI_Model {
    ...
    {
        $this->db->query('call sp7_insertarintegranteintermediaLCV1actnew('.$mfolio.',"'.$mtdocumento.'","'.$mndocumento.'","'.$mpnombre.'","'.$msnombre.'","'.$mpapellido.'","'.$msapellido.'","'.$mfnacimiento.'","'.$msexo.'",'.$medad.',"'.$mtelefono.'","'.$mcelular.'","'.$mcorreo.'","'.$mtwitter.'","'.$mfacebook.'","'.$minstagram.'","'.$mgoogle.'", '.$mdocumentocog.',"'.$mnacionalidadv.'", "'.$metnias.'", "'.$mOsexual.'", "'.$mIgenero.'");');
    }
    ...
    ,$metnias,$mOsexual,$mIgenero)
    {
        $this->db->query('call spactualizarintegranteintermnew('.$mfolio.','.$midintegrante.',"'.$mtdocumento.'","'.$mndocumento.'","'.$mpnombre.'","'.$msnombre.'","'.$mpapellido.'","'.$msapellido.'","'.$mfnacimiento.'","'.$msexo.'","'.$medad.'","'.$mtelefono.'","'.$mcelular.'","'.$mcorreo.'","'.$mtwitter.'","'.$mfacebook.'","'.$minstagram.'","'.$mgoogle.'","'.$mnacionalidadv.'", "'.$metnias.'", "'.$mOsexual.'", "'.$mIgenero.'", "'.date("Y-m-d H:i:s").'");');
    }    

...
class M_actualizar extends CI_Model {
    ...
    public function fm_actualizarh($mfolio,$mrephogar,$mmotivo,$mestrato,$mcomuna,$mbarrio,$mdireccion,$mtelefono,$mcelular,$mtelfcont,$mcelcont)
    {
        $this->db->query('call spactualizarhogar ('.$mfolio.',"'.$mrephogar.'","'.$mmotivo.'","'.$mestrato.'","'.$mcomuna.'","'.$mbarrio.'","'.$mdireccion.'","'.$mtelefono.'","'.$mcelular.'","'.$mtelfcont.'","'.$mcelcont.'","'.date("Y-m-d H:i:s").'");');
    }    

...
class M_integrantes extends CI_Model {
    ...
    public function fm_insertar($mfolio,$mtdocumento,$mndocumento,$mpnombre,$msnombre,$mpapellido,$msapellido,$mfnacimiento,$msexo,$medad,$mtelefono,$mcelular,$mcorreo,$mtwitter,$mfacebook,$minstagram,$mgoogle,$mnacionalidadv
    ,$metnias,$mOsexual,$mIgenero)
    {
        $this->db->query('call spinsertarintegranteact('.$mfolio.',"'.$mtdocumento.'","'.$mndocumento.'","'.$mpnombre.'","'.$msnombre.'","'.$mpapellido.'","'.$msapellido.'","'.$mfnacimiento.'","'.$msexo.'",'.$medad.',"'.$mtelefono.'","'.$mcelular.'","'.$mcorreo.'","'.$mtwitter.'","'.$mfacebook.'","'.$minstagram.'","'.$mgoogle.'","'.$mnacionalidadv.'", "'.$metnias.'", "'.$mOsexual.'", "'.$mIgenero.'", "'.date("Y-m-d H:i:s").'", "'.date("Y-m-d H:i:s").'");');
    }
    ...
    ,$metnias,$mOsexual,$mIgenero)
    {
      $this->db->query('call spactualizarintegranteact('.$mfolio.','.$midintegrante.',"'.$mtdocumento.'","'.$mndocumento.'","'.$mpnombre.'","'.$msnombre.'","'.$mpapellido.'","'.$msapellido.'","'.$mfnacimiento.'","'.$msexo.'","'.$medad.'","'.$mtelefono.'","'.$mcelular.'","'.$mcorreo.'","'.$mtwitter.'","'.$mfacebook.'","'.$minstagram.'","'.$mgoogle.'","'.$mnacionalidadv.'", "'.$metnias.'", "'.$mOsexual.'", "'.$mIgenero.'", "'.date("Y-m-d H:i:s").'");');
    }    
     ...
     ,$metnias,$mOsexual,$mIgenero)
    {
        $this->db->query('call spactualizarintegrantesincalculoactnew('.$mfolio.','.$midintegrante.',"'.$mtdocumento.'","'.$mndocumento.'","'.$mpnombre.'","'.$msnombre.'","'.$mpapellido.'","'.$msapellido.'","'.$mtelefono.'","'.$mcelular.'","'.$mcorreo.'","'.$mtwitter.'","'.$mfacebook.'","'.$minstagram.'","'.$mgoogle.'","'.$mnacionalidadv.'", "'.$metnias.'", "'.$mOsexual.'", "'.$mIgenero.'", "'.date("Y-m-d H:i:s").'");');
    }   
   ...
   public function fm_eliminar($mfolio,$midintegrante)
    ...
    public function fm_listarpaises()
    {
     ...
     //esta funcion se encargar de insertar a la base de datos, los datos enviados desde el controlador
     public function fm_datosmenores($folio)
     {
         $query = $this->db->query('call sptraerdatosunifamiliar('.$folio.');');
         $resultado = $query->result();
         $query->next_result(); //NO SE TOCAN Estas dos funciones permiten realizar varias consultas en el mismo controlador.
         $query->free_result(); //NO SE TOCAN  Estas dos funciones permiten realizar varias consultas en el mismo controlador.
         return $resultado;        

...
class M_capap13sc extends CI_Model {
    ...
    {
        $query = $this->db->query('call sp3ayudas("capap13");');//se coloca el codigo de la ayuda
...
//esta funcion ejecuta el sp para cargar si ya tiene respuesta la pregunta
    ...
    {
        $query = $this->db->query('call spbuscarcapap13sc('.$mfolio.');');
        $resultado = $query->result();
        $query->next_result(); //NO SE TOCAN Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        $query->free_result(); //NO SE TOCAN  Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        return $resultado;        
    ...
    public function fm_actualizarpregunta($mfolio,$mcapap13)
    {
        $this->db->query('call spactualizarcapap13sc('.$mfolio.',"'.$mcapap13.'");');
    }    

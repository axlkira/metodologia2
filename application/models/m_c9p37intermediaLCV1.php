...
class M_c9p37intermediaLCV1 extends CI_Model {
    ...
    {
            $query = $this->db->query('call spbuscarcapitulo9p37intermediaLCV1('.$midintegrante.');');
        $resultado = $query->result();
        $query->next_result(); //NO SE TOCAN Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        $query->free_result(); //NO SE TOCAN  Estas dos funciones permiten realizar varias consultas en el mismo controlador.
        return $resultado;        
    ...
    {
        $this->db->query('call spactualizarcapitulo9p37intermediaLCV1('.$mfolio.','.$midintegrante.',"'.$mvc9p37intermediao1.'","'.$mvc9p37intermediao2.'","'.$mvc9p37intermediao3.'","'.$mvc9p37intermediao4.'","'.$mvc9p37intermediao5.'","'.$mvc9p37intermediao6.'","'.$mvc9p37intermediao7.'","'.$mvc9p37intermediao8.'","'.$mvc9p37intermediao9.'","'.$mvc9p37intermediao10.'","'.$mvc9p37intermediao11.'","'.$mvc9p37intermediacual.'");');
    }    

...
class M_accionessueno extends CI_Model {
    ...
    public function fm_principalsuenoacciones($folio,$idsueno,$idintegrante)
    {
        $query = $this->db->query('call spbuscarsuenoacciones ('.$folio.','.$idsueno.','.$idintegrante.');');
    ...
    public function fm_insertar($midsueno,$mfolio,$midintegrante,$mnombresuenotiempo,$msuenotiempo)
    {
        $this->db->query('call spinsertarseunotiempo('.$midsueno.','.$mfolio.','.$midintegrante.',"'.$mnombresuenotiempo.'","'.$msuenotiempo.'");');
    }

...
class M_protocolol1e2 extends CI_Model {
   ...
   public function fm_cerrarestacion($mfolio,$midestacion,$mestado,$midcobertura,$mdoccogestor,$mlongitud,$mlatitud,$mmensajedonde) {
    ...
    public function fm_insertarfoliocapacidades($mfolio) {
        $this->db->query('call spinsertarfoliocapacidades('.$mfolio.');');
    } 
    
    public function fm_insertarfolioexitoso($mfolio) {
        $this->db->query('call spinsertarfolioexitoso('.$mfolio.');');
    }  

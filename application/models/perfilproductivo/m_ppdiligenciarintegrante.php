...
class M_ppdiligenciarintegrante extends CI_Model {
    ...
    {        
        $query = $this->db->query('call sppplistartabladiligenciarintegrante('.$mfolio.');');//se llama por procedimiento l almacenado
    ...
    public function fm_llenarppcapitulosintegrante($mfolio,$midintegrante)
    {
        $this->db->query('call sp2llenarppcapitulosintegrante('.$mfolio.','.$midintegrante.');');
    }

...
class M_privacionesLCV1 extends CI_Model {
    ...
    public function fm_privacionresultado($folio,$idlogro)
    {        
        $query = $this->db->query('call sp5privacionresultadointermediaLCV1('.$folio.','.$idlogro.');');//se llama por procedimiento l almacenado

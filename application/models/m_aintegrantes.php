...
class M_aintegrantes extends CI_Model {
    ...
    public function fm_insertar($mfolio,$mtdocumento,$mndocumento,$mpnombre,$msnombre,$mpapellido,$msapellido,$mfnacimiento,$msexo,$medad,$mtelefono,$mcelular,$mcorreo,$mtwitter,$mfacebook,$minstagram,$mgoogle)
    {
        $this->db->query('call spinsertarintegrante('.$mfolio.',"'.$mtdocumento.'",'.$mndocumento.',"'.$mpnombre.'","'.$msnombre.'","'.$mpapellido.'","'.$msapellido.'","'.$mfnacimiento.'","'.$msexo.'",'.$medad.',"'.$mtelefono.'","'.$mcelular.'","'.$mcorreo.'","'.$mtwitter.'","'.$mfacebook.'","'.$minstagram.'","'.$mgoogle.'", "'.date("Y-m-d H:i:s").'", "'.date("Y-m-d H:i:s").'");');
    }

...
class M_c1p1ap12 extends CI_Model {
    ...
    public function fm_insertar($mfolio,$mc1p1,$mc1p2,$mc1p3,$mc1p4,$mc1p5,$mc1p6,$mc1p7,$mc1p8,$mc1p9,$mc1p10,$mc1p11,$mc1p11a,$mc1p12,$mc1p13)
    {
        $this->db->query('call spinsertarc1p1ap12('.$mfolio.',"'.$mc1p1.'","'.$mc1p2.'","'.$mc1p3.'","'.$mc1p4.'","'.$mc1p5.'","'.$mc1p6.'","'.$mc1p7.'","'.$mc1p8.'","'.$mc1p9.'","'.$mc1p10.'","'.$mc1p11.'","'.$mc1p11a.'","'.$mc1p12.'","'.$mc1p13.'");');
    }
    
    //esta funcion actualiza
    public function fm_actualizar($mfolio,$mc1p1,$mc1p2,$mc1p3,$mc1p4,$mc1p5,$mc1p6,$mc1p7,$mc1p8,$mc1p9,$mc1p10,$mc1p11,$mc1p11a,$mc1p12,$mc1p13)
    {
        $this->db->query('call spactualizarc1p1ap12 ('.$mfolio.',"'.$mc1p1.'","'.$mc1p2.'","'.$mc1p3.'","'.$mc1p4.'","'.$mc1p5.'","'.$mc1p6.'","'.$mc1p7.'","'.$mc1p8.'","'.$mc1p9.'","'.$mc1p10.'","'.$mc1p11.'","'.$mc1p11a.'","'.$mc1p12.'","'.$mc1p13.'");');
    }    
    public function fm_cerrar($mfolio,$mcerrarcap1) {
        $this->db->query('call spcerrarc1p1ap12('.$mfolio.',"'.$mcerrarcap1.'","'.date("Y-m-d H:i:s").'");');
    }   
    
    public function fm_unipersonal($mfolio)
    {
        $this->db->query('call spunipersonalhogar ('.$mfolio.');');
    }
    
    
    public function fm_unipersonalborrar($mfolio)
    {
        $this->db->query('call spunipersonalhogarborrar ('.$mfolio.');');
    }

...
class M_integranteintermedia extends CI_Model {
    ...
    public function fm_cerrarpaso($mfolio,$midpaso,$mestado) {
     ...
     public function fm_insertarcapintegrantesintermedia($mfolio,$mvidintegrante) {
        $this->db->query('call spinsertacapitulointegranteintermedia('.$mfolio.','.$mvidintegrante.');');
    }
